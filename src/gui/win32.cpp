...
void GUI::build_envelopes_body()
{
    ...
    ADD_PE(envelopes_body, 343,             44, synth, ParamId::E2AMT,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 343 + PE_W,      44, synth, ParamId::E2INI,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 343 + PE_W * 2,  44, synth, ParamId::E2PK,   MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 343 + PE_W * 3,  44, synth, ParamId::E2SUS,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 343 + PE_W * 4,  44, synth, ParamId::E2FIN,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 343,            164, synth, ParamId::E2DEL,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body, 343 + PE_W,     164, synth, ParamId::E2ATK,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body, 343 + PE_W * 2, 164, synth, ParamId::E2HLD,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body, 343 + PE_W * 3, 164, synth, ParamId::E2DEC,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body, 343 + PE_W * 4, 164, synth, ParamId::E2REL,  MIDI_CTLS, "%.3f", 1.0);

    ADD_PE(envelopes_body, 649,             44, synth, ParamId::E3AMT,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 649 + PE_W,      44, synth, ParamId::E3INI,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 649 + PE_W * 2,  44, synth, ParamId::E3PK,   MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 649 + PE_W * 3,  44, synth, ParamId::E3SUS,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 649 + PE_W * 4,  44, synth, ParamId::E3FIN,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 649,            164, synth, ParamId::E3DEL,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body, 649 + PE_W,     164, synth, ParamId::E3ATK,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body, 649 + PE_W * 2, 164, synth, ParamId::E3HLD,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body, 649 + PE_W * 3, 164, synth, ParamId::E3DEC,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body, 649 + PE_W * 4, 164, synth, ParamId::E3REL,  MIDI_CTLS, "%.3f", 1.0);

    ADD_PE(envelopes_body,  37,            324, synth, ParamId::E4AMT,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body,  37 + PE_W,     324, synth, ParamId::E4INI,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body,  37 + PE_W * 2, 324, synth, ParamId::E4PK,   MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body,  37 + PE_W * 3, 324, synth, ParamId::E4SUS,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body,  37 + PE_W * 4, 324, synth, ParamId::E4FIN,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body,  37,            444, synth, ParamId::E4DEL,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body,  37 + PE_W,     444, synth, ParamId::E4ATK,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body,  37 + PE_W * 2, 444, synth, ParamId::E4HLD,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body,  37 + PE_W * 3, 444, synth, ParamId::E4DEC,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body,  37 + PE_W * 4, 444, synth, ParamId::E4REL,  MIDI_CTLS, "%.3f", 1.0);

    ADD_PE(envelopes_body, 343,            324, synth, ParamId::E5AMT,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 343 + PE_W,     324, synth, ParamId::E5INI,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 343 + PE_W * 2, 324, synth, ParamId::E5PK,   MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 343 + PE_W * 3, 324, synth, ParamId::E5SUS,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 343 + PE_W * 4, 324, synth, ParamId::E5FIN,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 343,            444, synth, ParamId::E5DEL,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body, 343 + PE_W,     444, synth, ParamId::E5ATK,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body, 343 + PE_W * 2, 444, synth, ParamId::E5HLD,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body, 343 + PE_W * 3, 444, synth, ParamId::E5DEC,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body, 343 + PE_W * 4, 444, synth, ParamId::E5REL,  MIDI_CTLS, "%.3f", 1.0);

    ADD_PE(envelopes_body, 649,            324, synth, ParamId::E6AMT,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 649 + PE_W,     324, synth, ParamId::E6INI,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 649 + PE_W * 2, 324, synth, ParamId::E6PK,   MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 649 + PE_W * 3, 324, synth, ParamId::E6SUS,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 649 + PE_W * 4, 324, synth, ParamId::E6FIN,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 649,            444, synth, ParamId::E6DEL,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body, 649 + PE_W,     444, synth, ParamId::E6ATK,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body, 649 + PE_W * 2, 444, synth, ParamId::E6HLD,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body, 649 + PE_W * 3, 444, synth, ParamId::E6DEC,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body, 649 + PE_W * 4, 444, synth, ParamId::E6REL,  MIDI_CTLS, "%.3f", 1.0);
