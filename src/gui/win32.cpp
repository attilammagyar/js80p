...
void GUI::build_controllers_body()
{
    ...
    ADD_PE(controllers_body,  21,             44, synth, ParamId::F1IN,     MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body,  21 + PE_W,      44, synth, ParamId::F1MIN,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body,  21 + PE_W * 2,  44, synth, ParamId::F1MAX,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body,  21,            164, synth, ParamId::F1AMT,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body,  21 + PE_W,     164, synth, ParamId::F1DST,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body,  21 + PE_W * 2, 164, synth, ParamId::F1RND,    MIDI_CTLS, "%.2f", 100.0);

    ADD_PE(controllers_body, 211,             44, synth, ParamId::F2IN,     MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 211 + PE_W,      44, synth, ParamId::F2MIN,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 211 + PE_W * 2,  44, synth, ParamId::F2MAX,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 211,            164, synth, ParamId::F2AMT,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 211 + PE_W,     164, synth, ParamId::F2DST,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 211 + PE_W * 2, 164, synth, ParamId::F2RND,    MIDI_CTLS, "%.2f", 100.0);

    ADD_PE(controllers_body, 401,             44, synth, ParamId::F3IN,     MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 401 + PE_W,      44, synth, ParamId::F3MIN,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 401 + PE_W * 2,  44, synth, ParamId::F3MAX,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 401,            164, synth, ParamId::F3AMT,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 401 + PE_W,     164, synth, ParamId::F3DST,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 401 + PE_W * 2, 164, synth, ParamId::F3RND,    MIDI_CTLS, "%.2f", 100.0);

    ADD_PE(controllers_body, 591,             44, synth, ParamId::F4IN,     MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 591 + PE_W,      44, synth, ParamId::F4MIN,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 591 + PE_W * 2,  44, synth, ParamId::F4MAX,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 591,            164, synth, ParamId::F4AMT,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 591 + PE_W,     164, synth, ParamId::F4DST,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 591 + PE_W * 2, 164, synth, ParamId::F4RND,    MIDI_CTLS, "%.2f", 100.0);

    ADD_PE(controllers_body, 781,             44, synth, ParamId::F5IN,     MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 781 + PE_W,      44, synth, ParamId::F5MIN,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 781 + PE_W * 2,  44, synth, ParamId::F5MAX,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 781,            164, synth, ParamId::F5AMT,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 781 + PE_W,     164, synth, ParamId::F5DST,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 781 + PE_W * 2, 164, synth, ParamId::F5RND,    MIDI_CTLS, "%.2f", 100.0);

    ADD_PE(controllers_body,  21,            324, synth, ParamId::F6IN,     MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body,  21 + PE_W,     324, synth, ParamId::F6MIN,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body,  21 + PE_W * 2, 324, synth, ParamId::F6MAX,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body,  21,            444, synth, ParamId::F6AMT,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body,  21 + PE_W,     444, synth, ParamId::F6DST,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body,  21 + PE_W * 2, 444, synth, ParamId::F6RND,    MIDI_CTLS, "%.2f", 100.0);

    ADD_PE(controllers_body, 211,            324, synth, ParamId::F7IN,     MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 211 + PE_W,     324, synth, ParamId::F7MIN,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 211 + PE_W * 2, 324, synth, ParamId::F7MAX,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 211,            444, synth, ParamId::F7AMT,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 211 + PE_W,     444, synth, ParamId::F7DST,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 211 + PE_W * 2, 444, synth, ParamId::F7RND,    MIDI_CTLS, "%.2f", 100.0);

    ADD_PE(controllers_body, 401,            324, synth, ParamId::F8IN,     MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 401 + PE_W,     324, synth, ParamId::F8MIN,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 401 + PE_W * 2, 324, synth, ParamId::F8MAX,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 401,            444, synth, ParamId::F8AMT,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 401 + PE_W,     444, synth, ParamId::F8DST,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 401 + PE_W * 2, 444, synth, ParamId::F8RND,    MIDI_CTLS, "%.2f", 100.0);

    ADD_PE(controllers_body, 591,            324, synth, ParamId::F9IN,     MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 591 + PE_W,     324, synth, ParamId::F9MIN,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 591 + PE_W * 2, 324, synth, ParamId::F9MAX,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 591,            444, synth, ParamId::F9AMT,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 591 + PE_W,     444, synth, ParamId::F9DST,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 591 + PE_W * 2, 444, synth, ParamId::F9RND,    MIDI_CTLS, "%.2f", 100.0);

    ADD_PE(controllers_body, 781,            324, synth, ParamId::F10IN,     MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 781 + PE_W,     324, synth, ParamId::F10MIN,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 781 + PE_W * 2, 324, synth, ParamId::F10MAX,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 781,            444, synth, ParamId::F10AMT,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 781 + PE_W,     444, synth, ParamId::F10DST,    MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(controllers_body, 781 + PE_W * 2, 444, synth, ParamId::F10RND,    MIDI_CTLS, "%.2f", 100.0);
...
void GUI::build_envelopes_body()
{
    ...
    ADD_PE(envelopes_body,  37,             44, synth, ParamId::N1AMT,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body,  37 + PE_W,      44, synth, ParamId::N1INI,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body,  37 + PE_W * 2,  44, synth, ParamId::N1PK,   MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body,  37 + PE_W * 3,  44, synth, ParamId::N1SUS,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body,  37 + PE_W * 4,  44, synth, ParamId::N1FIN,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body,  37,            164, synth, ParamId::N1DEL,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body,  37 + PE_W,     164, synth, ParamId::N1ATK,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body,  37 + PE_W * 2, 164, synth, ParamId::N1HLD,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body,  37 + PE_W * 3, 164, synth, ParamId::N1DEC,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body,  37 + PE_W * 4, 164, synth, ParamId::N1REL,  MIDI_CTLS, "%.3f", 1.0);

    ADD_PE(envelopes_body, 343,             44, synth, ParamId::N2AMT,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 343 + PE_W,      44, synth, ParamId::N2INI,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 343 + PE_W * 2,  44, synth, ParamId::N2PK,   MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 343 + PE_W * 3,  44, synth, ParamId::N2SUS,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 343 + PE_W * 4,  44, synth, ParamId::N2FIN,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 343,            164, synth, ParamId::N2DEL,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body, 343 + PE_W,     164, synth, ParamId::N2ATK,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body, 343 + PE_W * 2, 164, synth, ParamId::N2HLD,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body, 343 + PE_W * 3, 164, synth, ParamId::N2DEC,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body, 343 + PE_W * 4, 164, synth, ParamId::N2REL,  MIDI_CTLS, "%.3f", 1.0);

    ADD_PE(envelopes_body, 649,             44, synth, ParamId::N3AMT,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 649 + PE_W,      44, synth, ParamId::N3INI,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 649 + PE_W * 2,  44, synth, ParamId::N3PK,   MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 649 + PE_W * 3,  44, synth, ParamId::N3SUS,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 649 + PE_W * 4,  44, synth, ParamId::N3FIN,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 649,            164, synth, ParamId::N3DEL,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body, 649 + PE_W,     164, synth, ParamId::N3ATK,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body, 649 + PE_W * 2, 164, synth, ParamId::N3HLD,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body, 649 + PE_W * 3, 164, synth, ParamId::N3DEC,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body, 649 + PE_W * 4, 164, synth, ParamId::N3REL,  MIDI_CTLS, "%.3f", 1.0);

    ADD_PE(envelopes_body,  37,            324, synth, ParamId::N4AMT,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body,  37 + PE_W,     324, synth, ParamId::N4INI,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body,  37 + PE_W * 2, 324, synth, ParamId::N4PK,   MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body,  37 + PE_W * 3, 324, synth, ParamId::N4SUS,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body,  37 + PE_W * 4, 324, synth, ParamId::N4FIN,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body,  37,            444, synth, ParamId::N4DEL,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body,  37 + PE_W,     444, synth, ParamId::N4ATK,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body,  37 + PE_W * 2, 444, synth, ParamId::N4HLD,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body,  37 + PE_W * 3, 444, synth, ParamId::N4DEC,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body,  37 + PE_W * 4, 444, synth, ParamId::N4REL,  MIDI_CTLS, "%.3f", 1.0);

    ADD_PE(envelopes_body, 343,            324, synth, ParamId::N5AMT,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 343 + PE_W,     324, synth, ParamId::N5INI,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 343 + PE_W * 2, 324, synth, ParamId::N5PK,   MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 343 + PE_W * 3, 324, synth, ParamId::N5SUS,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 343 + PE_W * 4, 324, synth, ParamId::N5FIN,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 343,            444, synth, ParamId::N5DEL,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body, 343 + PE_W,     444, synth, ParamId::N5ATK,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body, 343 + PE_W * 2, 444, synth, ParamId::N5HLD,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body, 343 + PE_W * 3, 444, synth, ParamId::N5DEC,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body, 343 + PE_W * 4, 444, synth, ParamId::N5REL,  MIDI_CTLS, "%.3f", 1.0);

    ADD_PE(envelopes_body, 649,            324, synth, ParamId::N6AMT,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 649 + PE_W,     324, synth, ParamId::N6INI,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 649 + PE_W * 2, 324, synth, ParamId::N6PK,   MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 649 + PE_W * 3, 324, synth, ParamId::N6SUS,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 649 + PE_W * 4, 324, synth, ParamId::N6FIN,  MIDI_CTLS, "%.2f", 100.0);
    ADD_PE(envelopes_body, 649,            444, synth, ParamId::N6DEL,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body, 649 + PE_W,     444, synth, ParamId::N6ATK,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body, 649 + PE_W * 2, 444, synth, ParamId::N6HLD,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body, 649 + PE_W * 3, 444, synth, ParamId::N6DEC,  MIDI_CTLS, "%.3f", 1.0);
    ADD_PE(envelopes_body, 649 + PE_W * 4, 444, synth, ParamId::N6REL,  MIDI_CTLS, "%.3f", 1.0);
