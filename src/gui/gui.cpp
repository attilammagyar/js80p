...
GUI::Controller const GUI::CONTROLLERS[] = {
    ...
    Controller(73, Synth::ControllerId::SHAPED_CONTROLLER_1, "Shaped Controller 1", "SC 1"),
    Controller(74, Synth::ControllerId::SHAPED_CONTROLLER_2, "Shaped Controller 2", "SC 2"),
    Controller(75, Synth::ControllerId::SHAPED_CONTROLLER_3, "Shaped Controller 3", "SC 3"),
    Controller(76, Synth::ControllerId::SHAPED_CONTROLLER_4, "Shaped Controller 4", "SC 4"),
    Controller(77, Synth::ControllerId::SHAPED_CONTROLLER_5, "Shaped Controller 5", "SC 5"),
    Controller(78, Synth::ControllerId::SHAPED_CONTROLLER_6, "Shaped Controller 6", "SC 6"),
    Controller(79, Synth::ControllerId::SHAPED_CONTROLLER_7, "Shaped Controller 7", "SC 7"),
    Controller(80, Synth::ControllerId::SHAPED_CONTROLLER_8, "Shaped Controller 8", "SC 8"),
    Controller(81, Synth::ControllerId::SHAPED_CONTROLLER_9, "Shaped Controller 9", "SC 9"),
    Controller(82, Synth::ControllerId::SHAPED_CONTROLLER_10, "Shaped Controller 10", "SC 10"),
