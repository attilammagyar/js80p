...
void GUI::build_effects_body(ParamStateImages const* knob_states)
{
    ...
    KNOB(effects_body, 142 + KNOB_W * 0,   173, Synth::ParamId::ECTYP,  MM___,      ct, ctc, knob_states);
    KNOB(effects_body, 142 + KNOB_W * 1,   173, Synth::ParamId::ECDEL,  MML__,      "%.4f", 1.0, knob_states);
    KNOB(effects_body, 142 + KNOB_W * 2,   173, Synth::ParamId::ECFRQ,  MML_C,      "%.3f", 1.0, knob_states);
    KNOB(effects_body, 142 + KNOB_W * 3,   173, Synth::ParamId::ECDPT,  MML_C,      "%.2f", 200.0, knob_states);
    KNOB(effects_body, 142 + KNOB_W * 4,   173, Synth::ParamId::ECFB,   MML_C,      "%.2f", 100.0 * (Number)Constants::CHORUS_FEEDBACK_SCALE, knob_states);
    KNOB(effects_body, 142 + KNOB_W * 5,   173, Synth::ParamId::ECDF,   MML__,      "%.1f", 1.0, knob_states);
    KNOB(effects_body, 142 + KNOB_W * 6,   173, Synth::ParamId::ECDG,   MML_C,      "%.2f", 1.0, knob_states);
    KNOB(effects_body, 142 + KNOB_W * 7,   173, Synth::ParamId::ECWID,  MML_C,      "%.2f", 100.0, knob_states);
    KNOB(effects_body, 142 + KNOB_W * 8,   173, Synth::ParamId::ECHPF,  MML__,      "%.1f", 1.0, knob_states);
    KNOB(effects_body, 142 + KNOB_W * 9,   173, Synth::ParamId::ECHPQ,  MML__,      "%.3f", 1.0, knob_states);
    ...
    TOGG(effects_body, 276, 145, 114, 24,  0, Synth::ParamId::ECLLG);
    TOGG(effects_body, 451, 145, 136, 24,  0, Synth::ParamId::ECLOG);
    TOGG(effects_body, 665, 145,  50, 24,  0, Synth::ParamId::ECLHQ);
    TOGG(effects_body, 749, 145,  90, 24, 66, Synth::ParamId::ECSYN);

    KNOB(effects_body,  55 + KNOB_W * 0,   313, Synth::ParamId::EEDEL,  MML__,      "%.3f", 1.0, knob_states);
    KNOB(effects_body,  55 + KNOB_W * 1,   313, Synth::ParamId::EEINV,  MML__,      "%.2f", 100.0, knob_states);
    KNOB(effects_body,  55 + KNOB_W * 2,   313, Synth::ParamId::EEFB,   MML_C,      "%.2f", 100.0, knob_states);
    KNOB(effects_body,  55 + KNOB_W * 3,   313, Synth::ParamId::EEDST,  MML_C,      "%.2f", 100.0, knob_states);
    KNOB(effects_body,  55 + KNOB_W * 4,   313, Synth::ParamId::EEDF,   MML__,      "%.1f", 1.0, knob_states);
    KNOB(effects_body,  55 + KNOB_W * 5,   313, Synth::ParamId::EEDG,   MML_C,      "%.2f", 1.0, knob_states);
    KNOB(effects_body,  55 + KNOB_W * 6,   313, Synth::ParamId::EEWID,  MML_C,      "%.2f", 100.0, knob_states);
    KNOB(effects_body,  55 + KNOB_W * 7,   313, Synth::ParamId::EEHPF,  MML__,      "%.1f", 1.0, knob_states);
    KNOB(effects_body,  55 + KNOB_W * 8,   313, Synth::ParamId::EEHPQ,  MML__,      "%.3f", 1.0, knob_states);
    ...
    TOGG(effects_body, 521, 285,  50, 24,  0, Synth::ParamId::EELHQ);
    TOGG(effects_body, 836, 285,  90, 24, 66, Synth::ParamId::EESYN);

    KNOB(effects_body,  33 + KNOB_W * 0,   453, Synth::ParamId::ERTYP,  MM___,      rt, rtc, knob_states);
    KNOB(effects_body,  33 + KNOB_W * 1,   453, Synth::ParamId::ERRS,   MML_C,      "%.2f", 100.0, knob_states);
    KNOB(effects_body,  33 + KNOB_W * 2,   453, Synth::ParamId::ERDST,  MML_C,      "%.2f", 100.0, knob_states);
    KNOB(effects_body,  33 + KNOB_W * 3,   453, Synth::ParamId::ERDF,   MML__,      "%.1f", 1.0, knob_states);
    KNOB(effects_body,  33 + KNOB_W * 4,   453, Synth::ParamId::ERDG,   MML_C,      "%.2f", 1.0, knob_states);
    KNOB(effects_body,  33 + KNOB_W * 5,   453, Synth::ParamId::ERWID,  MML_C,      "%.2f", 100.0, knob_states);
    KNOB(effects_body,  33 + KNOB_W * 6,   453, Synth::ParamId::ERHPF,  MML__,      "%.1f", 1.0, knob_states);
    KNOB(effects_body,  33 + KNOB_W * 7,   453, Synth::ParamId::ERHPQ,  MML__,      "%.3f", 1.0, knob_states);
    ...
    TOGG(effects_body, 226, 425,  96, 24,  0, Synth::ParamId::ERLOG);
    TOGG(effects_body, 441, 425,  50, 24,  0, Synth::ParamId::ERLHQ);
