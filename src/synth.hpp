...
class Synth : public Midi::EventHandler, public SignalProducer
{
    ...
    public:
        ...
        enum ParamId {
            ...
            MPW = 6,         ///< Modulator Pulse Width
            MAMP = 7,        ///< Modulator Amplitude
            MVS = 8,         ///< Modulator Velocity Sensitivity
            MFLD = 9,        ///< Modulator Folding
            MPRT = 10,       ///< Modulator Portamento Length
            MPRD = 11,       ///< Modulator Portamento Depth
            MDTN = 12,       ///< Modulator Detune
            MFIN = 13,       ///< Modulator Fine Detune
            MWID = 14,       ///< Modulator Width
            MPAN = 15,       ///< Modulator Pan
            MVOL = 16,       ///< Modulator Volume
            MSUB = 17,       ///< Modulator Subharmonic Amplitude
            MC1 = 18,        ///< Modulator Custom Waveform 1st Harmonic
            MC2 = 19,        ///< Modulator Custom Waveform 2nd Harmonic
            MC3 = 20,        ///< Modulator Custom Waveform 3rd Harmonic
            MC4 = 21,        ///< Modulator Custom Waveform 4th Harmonic
            MC5 = 22,        ///< Modulator Custom Waveform 5th Harmonic
            MC6 = 23,        ///< Modulator Custom Waveform 6th Harmonic
            MC7 = 24,        ///< Modulator Custom Waveform 7th Harmonic
            MC8 = 25,        ///< Modulator Custom Waveform 8th Harmonic
            MC9 = 26,        ///< Modulator Custom Waveform 9th Harmonic
            MC10 = 27,       ///< Modulator Custom Waveform 10th Harmonic
            MF1FRQ = 28,     ///< Modulator Filter 1 Frequency
            MF1Q = 29,       ///< Modulator Filter 1 Q Factor
            MF1G = 30,       ///< Modulator Filter 1 Gain
            MF1FIA = 31,     ///< Modulator Filter 1 Frequency Inaccuracy
            MF1QIA = 32,     ///< Modulator Filter 1 Q Factor Inaccuracy
            MF2FRQ = 33,     ///< Modulator Filter 2 Frequency
            MF2Q = 34,       ///< Modulator Filter 2 Q Factor
            MF2G = 35,       ///< Modulator Filter 2 Gain
            MF2FIA = 36,     ///< Modulator Filter 2 Frequency Inaccuracy
            MF2QIA = 37,     ///< Modulator Filter 2 Q Factor Inaccuracy

            CN = 38,         ///< Carrier Noise Level
            CPW = 39,        ///< Carrier Pulse Width
            CAMP = 40,       ///< Carrier Amplitude
            CVS = 41,        ///< Carrier Velocity Sensitivity
            CFLD = 42,       ///< Carrier Folding
            CPRT = 43,       ///< Carrier Portamento Length
            CPRD = 44,       ///< Carrier Portamento Depth
            CDTN = 45,       ///< Carrier Detune
            CFIN = 46,       ///< Carrier Fine Detune
            CWID = 47,       ///< Carrier Width
            CPAN = 48,       ///< Carrier Pan
            CVOL = 49,       ///< Carrier Volume
            CDL = 50,        ///< Carrier Distortion Level
            CC1 = 51,        ///< Carrier Custom Waveform 1st Harmonic
            CC2 = 52,        ///< Carrier Custom Waveform 2nd Harmonic
            CC3 = 53,        ///< Carrier Custom Waveform 3rd Harmonic
            CC4 = 54,        ///< Carrier Custom Waveform 4th Harmonic
            CC5 = 55,        ///< Carrier Custom Waveform 5th Harmonic
            CC6 = 56,        ///< Carrier Custom Waveform 6th Harmonic
            CC7 = 57,        ///< Carrier Custom Waveform 7th Harmonic
            CC8 = 58,        ///< Carrier Custom Waveform 8th Harmonic
            CC9 = 59,        ///< Carrier Custom Waveform 9th Harmonic
            CC10 = 60,       ///< Carrier Custom Waveform 10th Harmonic
            CF1FRQ = 61,     ///< Carrier Filter 1 Frequency
            CF1Q = 62,       ///< Carrier Filter 1 Q Factor
            CF1G = 63,       ///< Carrier Filter 1 Gain
            CF1FIA = 64,     ///< Carrier Filter 1 Frequency Inaccuracy
            CF1QIA = 65,     ///< Carrier Filter 1 Q Factor Inaccuracy
            CF2FRQ = 66,     ///< Carrier Filter 2 Frequency
            CF2Q = 67,       ///< Carrier Filter 2 Q Factor
            CF2G = 68,       ///< Carrier Filter 2 Gain
            ...
            M1MIN = 131,     ///< Macro 1 Minimum Value
            M1MAX = 132,     ///< Macro 1 Maximum Value
            M1SCL = 133,     ///< Macro 1 Scale
            M1DST = 134,     ///< Macro 1 Distortion
            M1RND = 135,     ///< Macro 1 Randomness

            M2MID = 136,     ///< Macro 2 Midpoint
            M2IN = 137,      ///< Macro 2 Input
            M2MIN = 138,     ///< Macro 2 Minimum Value
            M2MAX = 139,     ///< Macro 2 Maximum Value
            M2SCL = 140,     ///< Macro 2 Scale
            M2DST = 141,     ///< Macro 2 Distortion
            M2RND = 142,     ///< Macro 2 Randomness

            M3MID = 143,     ///< Macro 3 Midpoint
            M3IN = 144,      ///< Macro 3 Input
            M3MIN = 145,     ///< Macro 3 Minimum Value
            M3MAX = 146,     ///< Macro 3 Maximum Value
            M3SCL = 147,     ///< Macro 3 Scale
            M3DST = 148,     ///< Macro 3 Distortion
            M3RND = 149,     ///< Macro 3 Randomness

            M4MID = 150,     ///< Macro 4 Midpoint
            M4IN = 151,      ///< Macro 4 Input
            M4MIN = 152,     ///< Macro 4 Minimum Value
            M4MAX = 153,     ///< Macro 4 Maximum Value
            M4SCL = 154,     ///< Macro 4 Scale
            M4DST = 155,     ///< Macro 4 Distortion
            M4RND = 156,     ///< Macro 4 Randomness

            M5MID = 157,     ///< Macro 5 Midpoint
            M5IN = 158,      ///< Macro 5 Input
            M5MIN = 159,     ///< Macro 5 Minimum Value
            M5MAX = 160,     ///< Macro 5 Maximum Value
            M5SCL = 161,     ///< Macro 5 Scale
            M5DST = 162,     ///< Macro 5 Distortion
            M5RND = 163,     ///< Macro 5 Randomness

            M6MID = 164,     ///< Macro 6 Midpoint
            M6IN = 165,      ///< Macro 6 Input
            M6MIN = 166,     ///< Macro 6 Minimum Value
            M6MAX = 167,     ///< Macro 6 Maximum Value
            M6SCL = 168,     ///< Macro 6 Scale
            M6DST = 169,     ///< Macro 6 Distortion
            M6RND = 170,     ///< Macro 6 Randomness

            M7MID = 171,     ///< Macro 7 Midpoint
            M7IN = 172,      ///< Macro 7 Input
            M7MIN = 173,     ///< Macro 7 Minimum Value
            M7MAX = 174,     ///< Macro 7 Maximum Value
            M7SCL = 175,     ///< Macro 7 Scale
            M7DST = 176,     ///< Macro 7 Distortion
            M7RND = 177,     ///< Macro 7 Randomness

            M8MID = 178,     ///< Macro 8 Midpoint
            M8IN = 179,      ///< Macro 8 Input
            M8MIN = 180,     ///< Macro 8 Minimum Value
            M8MAX = 181,     ///< Macro 8 Maximum Value
            M8SCL = 182,     ///< Macro 8 Scale
            M8DST = 183,     ///< Macro 8 Distortion
            M8RND = 184,     ///< Macro 8 Randomness

            M9MID = 185,     ///< Macro 9 Midpoint
            M9IN = 186,      ///< Macro 9 Input
            M9MIN = 187,     ///< Macro 9 Minimum Value
            M9MAX = 188,     ///< Macro 9 Maximum Value
            M9SCL = 189,     ///< Macro 9 Scale
            M9DST = 190,     ///< Macro 9 Distortion
            M9RND = 191,     ///< Macro 9 Randomness

            M10MID = 192,     ///< Macro 10 Midpoint
            M10IN = 193,      ///< Macro 10 Input
            M10MIN = 194,     ///< Macro 10 Minimum Value
            M10MAX = 195,     ///< Macro 10 Maximum Value
            M10SCL = 196,     ///< Macro 10 Scale
            M10DST = 197,     ///< Macro 10 Distortion
            M10RND = 198,     ///< Macro 10 Randomness

            M11MID = 199,     ///< Macro 11 Midpoint
            M11IN = 200,      ///< Macro 11 Input
            M11MIN = 201,     ///< Macro 11 Minimum Value
            M11MAX = 202,     ///< Macro 11 Maximum Value
            M11SCL = 203,     ///< Macro 11 Scale
            M11DST = 204,     ///< Macro 11 Distortion
            M11RND = 205,     ///< Macro 11 Randomness

            M12MID = 206,     ///< Macro 12 Midpoint
            M12IN = 207,      ///< Macro 12 Input
            M12MIN = 208,     ///< Macro 12 Minimum Value
            M12MAX = 209,     ///< Macro 12 Maximum Value
            M12SCL = 210,     ///< Macro 12 Scale
            M12DST = 211,     ///< Macro 12 Distortion
            M12RND = 212,     ///< Macro 12 Randomness

            M13MID = 213,     ///< Macro 13 Midpoint
            M13IN = 214,      ///< Macro 13 Input
            M13MIN = 215,     ///< Macro 13 Minimum Value
            M13MAX = 216,     ///< Macro 13 Maximum Value
            M13SCL = 217,     ///< Macro 13 Scale
            M13DST = 218,     ///< Macro 13 Distortion
            M13RND = 219,     ///< Macro 13 Randomness

            M14MID = 220,     ///< Macro 14 Midpoint
            M14IN = 221,      ///< Macro 14 Input
            M14MIN = 222,     ///< Macro 14 Minimum Value
            M14MAX = 223,     ///< Macro 14 Maximum Value
            M14SCL = 224,     ///< Macro 14 Scale
            M14DST = 225,     ///< Macro 14 Distortion
            M14RND = 226,     ///< Macro 14 Randomness

            M15MID = 227,     ///< Macro 15 Midpoint
            M15IN = 228,      ///< Macro 15 Input
            M15MIN = 229,     ///< Macro 15 Minimum Value
            M15MAX = 230,     ///< Macro 15 Maximum Value
            M15SCL = 231,     ///< Macro 15 Scale
            M15DST = 232,     ///< Macro 15 Distortion
            M15RND = 233,     ///< Macro 15 Randomness

            M16MID = 234,     ///< Macro 16 Midpoint
            M16IN = 235,      ///< Macro 16 Input
            M16MIN = 236,     ///< Macro 16 Minimum Value
            M16MAX = 237,     ///< Macro 16 Maximum Value
            M16SCL = 238,     ///< Macro 16 Scale
            M16DST = 239,     ///< Macro 16 Distortion
            M16RND = 240,     ///< Macro 16 Randomness

            M17MID = 241,     ///< Macro 17 Midpoint
            M17IN = 242,      ///< Macro 17 Input
            M17MIN = 243,     ///< Macro 17 Minimum Value
            M17MAX = 244,     ///< Macro 17 Maximum Value
            M17SCL = 245,     ///< Macro 17 Scale
            M17DST = 246,     ///< Macro 17 Distortion
            M17RND = 247,     ///< Macro 17 Randomness

            M18MID = 248,     ///< Macro 18 Midpoint
            M18IN = 249,      ///< Macro 18 Input
            M18MIN = 250,     ///< Macro 18 Minimum Value
            M18MAX = 251,     ///< Macro 18 Maximum Value
            M18SCL = 252,     ///< Macro 18 Scale
            M18DST = 253,     ///< Macro 18 Distortion
            M18RND = 254,     ///< Macro 18 Randomness

            M19MID = 255,     ///< Macro 19 Midpoint
            M19IN = 256,      ///< Macro 19 Input
            M19MIN = 257,     ///< Macro 19 Minimum Value
            M19MAX = 258,     ///< Macro 19 Maximum Value
            M19SCL = 259,     ///< Macro 19 Scale
            M19DST = 260,     ///< Macro 19 Distortion
            M19RND = 261,     ///< Macro 19 Randomness

            M20MID = 262,     ///< Macro 20 Midpoint
            M20IN = 263,      ///< Macro 20 Input
            M20MIN = 264,     ///< Macro 20 Minimum Value
            M20MAX = 265,     ///< Macro 20 Maximum Value
            M20SCL = 266,     ///< Macro 20 Scale
            M20DST = 267,     ///< Macro 20 Distortion
            M20RND = 268,     ///< Macro 20 Randomness

            M21MID = 269,     ///< Macro 21 Midpoint
            M21IN = 270,      ///< Macro 21 Input
            M21MIN = 271,     ///< Macro 21 Minimum Value
            M21MAX = 272,     ///< Macro 21 Maximum Value
            M21SCL = 273,     ///< Macro 21 Scale
            M21DST = 274,     ///< Macro 21 Distortion
            M21RND = 275,     ///< Macro 21 Randomness

            M22MID = 276,     ///< Macro 22 Midpoint
            M22IN = 277,      ///< Macro 22 Input
            M22MIN = 278,     ///< Macro 22 Minimum Value
            M22MAX = 279,     ///< Macro 22 Maximum Value
            M22SCL = 280,     ///< Macro 22 Scale
            M22DST = 281,     ///< Macro 22 Distortion
            M22RND = 282,     ///< Macro 22 Randomness

            M23MID = 283,     ///< Macro 23 Midpoint
            M23IN = 284,      ///< Macro 23 Input
            M23MIN = 285,     ///< Macro 23 Minimum Value
            M23MAX = 286,     ///< Macro 23 Maximum Value
            M23SCL = 287,     ///< Macro 23 Scale
            M23DST = 288,     ///< Macro 23 Distortion
            M23RND = 289,     ///< Macro 23 Randomness

            M24MID = 290,     ///< Macro 24 Midpoint
            M24IN = 291,      ///< Macro 24 Input
            M24MIN = 292,     ///< Macro 24 Minimum Value
            M24MAX = 293,     ///< Macro 24 Maximum Value
            M24SCL = 294,     ///< Macro 24 Scale
            M24DST = 295,     ///< Macro 24 Distortion
            M24RND = 296,     ///< Macro 24 Randomness

            M25MID = 297,     ///< Macro 25 Midpoint
            M25IN = 298,      ///< Macro 25 Input
            M25MIN = 299,     ///< Macro 25 Minimum Value
            M25MAX = 300,     ///< Macro 25 Maximum Value
            M25SCL = 301,     ///< Macro 25 Scale
            M25DST = 302,     ///< Macro 25 Distortion
            M25RND = 303,     ///< Macro 25 Randomness

            M26MID = 304,     ///< Macro 26 Midpoint
            M26IN = 305,      ///< Macro 26 Input
            M26MIN = 306,     ///< Macro 26 Minimum Value
            M26MAX = 307,     ///< Macro 26 Maximum Value
            M26SCL = 308,     ///< Macro 26 Scale
            M26DST = 309,     ///< Macro 26 Distortion
            M26RND = 310,     ///< Macro 26 Randomness

            M27MID = 311,     ///< Macro 27 Midpoint
            M27IN = 312,      ///< Macro 27 Input
            M27MIN = 313,     ///< Macro 27 Minimum Value
            M27MAX = 314,     ///< Macro 27 Maximum Value
            M27SCL = 315,     ///< Macro 27 Scale
            M27DST = 316,     ///< Macro 27 Distortion
            M27RND = 317,     ///< Macro 27 Randomness

            M28MID = 318,     ///< Macro 28 Midpoint
            M28IN = 319,      ///< Macro 28 Input
            M28MIN = 320,     ///< Macro 28 Minimum Value
            M28MAX = 321,     ///< Macro 28 Maximum Value
            M28SCL = 322,     ///< Macro 28 Scale
            M28DST = 323,     ///< Macro 28 Distortion
            M28RND = 324,     ///< Macro 28 Randomness

            M29MID = 325,     ///< Macro 29 Midpoint
            M29IN = 326,      ///< Macro 29 Input
            M29MIN = 327,     ///< Macro 29 Minimum Value
            M29MAX = 328,     ///< Macro 29 Maximum Value
            M29SCL = 329,     ///< Macro 29 Scale
            M29DST = 330,     ///< Macro 29 Distortion
            M29RND = 331,     ///< Macro 29 Randomness

            M30MID = 332,     ///< Macro 30 Midpoint
            M30IN = 333,      ///< Macro 30 Input
            M30MIN = 334,     ///< Macro 30 Minimum Value
            M30MAX = 335,     ///< Macro 30 Maximum Value
            M30SCL = 336,     ///< Macro 30 Scale
            M30DST = 337,     ///< Macro 30 Distortion
            M30RND = 338,     ///< Macro 30 Randomness

            N1SCL = 339,     ///< Envelope 1 Scale
            N1INI = 340,     ///< Envelope 1 Initial Level
            N1DEL = 341,     ///< Envelope 1 Delay Time
            N1ATK = 342,     ///< Envelope 1 Attack Time
            N1PK = 343,      ///< Envelope 1 Peak Level
            N1HLD = 344,     ///< Envelope 1 Hold Time
            N1DEC = 345,     ///< Envelope 1 Decay Time
            N1SUS = 346,     ///< Envelope 1 Sustain Level
            N1REL = 347,     ///< Envelope 1 Release Time
            N1FIN = 348,     ///< Envelope 1 Final Level
            N1TIN = 349,     ///< Envelope 1 Time Inaccuracy
            N1VIN = 350,     ///< Envelope 1 Level Inaccuracy

            N2SCL = 351,     ///< Envelope 2 Scale
            N2INI = 352,     ///< Envelope 2 Initial Level
            N2DEL = 353,     ///< Envelope 2 Delay Time
            N2ATK = 354,     ///< Envelope 2 Attack Time
            N2PK = 355,      ///< Envelope 2 Peak Level
            N2HLD = 356,     ///< Envelope 2 Hold Time
            N2DEC = 357,     ///< Envelope 2 Decay Time
            N2SUS = 358,     ///< Envelope 2 Sustain Level
            N2REL = 359,     ///< Envelope 2 Release Time
            N2FIN = 360,     ///< Envelope 2 Final Level
            N2TIN = 361,     ///< Envelope 2 Time Inaccuracy
            N2VIN = 362,     ///< Envelope 2 Level Inaccuracy

            N3SCL = 363,     ///< Envelope 3 Scale
            N3INI = 364,     ///< Envelope 3 Initial Level
            N3DEL = 365,     ///< Envelope 3 Delay Time
            N3ATK = 366,     ///< Envelope 3 Attack Time
            N3PK = 367,      ///< Envelope 3 Peak Level
            N3HLD = 368,     ///< Envelope 3 Hold Time
            N3DEC = 369,     ///< Envelope 3 Decay Time
            N3SUS = 370,     ///< Envelope 3 Sustain Level
            N3REL = 371,     ///< Envelope 3 Release Time
            N3FIN = 372,     ///< Envelope 3 Final Level
            N3TIN = 373,     ///< Envelope 3 Time Inaccuracy
            N3VIN = 374,     ///< Envelope 3 Level Inaccuracy

            N4SCL = 375,     ///< Envelope 4 Scale
            N4INI = 376,     ///< Envelope 4 Initial Level
            N4DEL = 377,     ///< Envelope 4 Delay Time
            N4ATK = 378,     ///< Envelope 4 Attack Time
            N4PK = 379,      ///< Envelope 4 Peak Level
            N4HLD = 380,     ///< Envelope 4 Hold Time
            N4DEC = 381,     ///< Envelope 4 Decay Time
            N4SUS = 382,     ///< Envelope 4 Sustain Level
            N4REL = 383,     ///< Envelope 4 Release Time
            N4FIN = 384,     ///< Envelope 4 Final Level
            N4TIN = 385,     ///< Envelope 4 Time Inaccuracy
            N4VIN = 386,     ///< Envelope 4 Level Inaccuracy

            N5SCL = 387,     ///< Envelope 5 Scale
            N5INI = 388,     ///< Envelope 5 Initial Level
            N5DEL = 389,     ///< Envelope 5 Delay Time
            N5ATK = 390,     ///< Envelope 5 Attack Time
            N5PK = 391,      ///< Envelope 5 Peak Level
            N5HLD = 392,     ///< Envelope 5 Hold Time
            N5DEC = 393,     ///< Envelope 5 Decay Time
            N5SUS = 394,     ///< Envelope 5 Sustain Level
            N5REL = 395,     ///< Envelope 5 Release Time
            N5FIN = 396,     ///< Envelope 5 Final Level
            N5TIN = 397,     ///< Envelope 5 Time Inaccuracy
            N5VIN = 398,     ///< Envelope 5 Level Inaccuracy

            N6SCL = 399,     ///< Envelope 6 Scale
            N6INI = 400,     ///< Envelope 6 Initial Level
            N6DEL = 401,     ///< Envelope 6 Delay Time
            N6ATK = 402,     ///< Envelope 6 Attack Time
            N6PK = 403,      ///< Envelope 6 Peak Level
            N6HLD = 404,     ///< Envelope 6 Hold Time
            N6DEC = 405,     ///< Envelope 6 Decay Time
            N6SUS = 406,     ///< Envelope 6 Sustain Level
            N6REL = 407,     ///< Envelope 6 Release Time
            N6FIN = 408,     ///< Envelope 6 Final Level
            N6TIN = 409,     ///< Envelope 6 Time Inaccuracy
            N6VIN = 410,     ///< Envelope 6 Level Inaccuracy

            N7SCL = 411,     ///< Envelope 7 Scale
            N7INI = 412,     ///< Envelope 7 Initial Level
            N7DEL = 413,     ///< Envelope 7 Delay Time
            N7ATK = 414,     ///< Envelope 7 Attack Time
            N7PK = 415,      ///< Envelope 7 Peak Level
            N7HLD = 416,     ///< Envelope 7 Hold Time
            N7DEC = 417,     ///< Envelope 7 Decay Time
            N7SUS = 418,     ///< Envelope 7 Sustain Level
            N7REL = 419,     ///< Envelope 7 Release Time
            N7FIN = 420,     ///< Envelope 7 Final Level
            N7TIN = 421,     ///< Envelope 7 Time Inaccuracy
            N7VIN = 422,     ///< Envelope 7 Level Inaccuracy

            N8SCL = 423,     ///< Envelope 8 Scale
            N8INI = 424,     ///< Envelope 8 Initial Level
            N8DEL = 425,     ///< Envelope 8 Delay Time
            N8ATK = 426,     ///< Envelope 8 Attack Time
            N8PK = 427,      ///< Envelope 8 Peak Level
            N8HLD = 428,     ///< Envelope 8 Hold Time
            N8DEC = 429,     ///< Envelope 8 Decay Time
            N8SUS = 430,     ///< Envelope 8 Sustain Level
            N8REL = 431,     ///< Envelope 8 Release Time
            N8FIN = 432,     ///< Envelope 8 Final Level
            N8TIN = 433,     ///< Envelope 8 Time Inaccuracy
            N8VIN = 434,     ///< Envelope 8 Level Inaccuracy

            N9SCL = 435,     ///< Envelope 9 Scale
            N9INI = 436,     ///< Envelope 9 Initial Level
            N9DEL = 437,     ///< Envelope 9 Delay Time
            N9ATK = 438,     ///< Envelope 9 Attack Time
            N9PK = 439,      ///< Envelope 9 Peak Level
            N9HLD = 440,     ///< Envelope 9 Hold Time
            N9DEC = 441,     ///< Envelope 9 Decay Time
            N9SUS = 442,     ///< Envelope 9 Sustain Level
            N9REL = 443,     ///< Envelope 9 Release Time
            N9FIN = 444,     ///< Envelope 9 Final Level
            N9TIN = 445,     ///< Envelope 9 Time Inaccuracy
            N9VIN = 446,     ///< Envelope 9 Level Inaccuracy

            N10SCL = 447,     ///< Envelope 10 Scale
            N10INI = 448,     ///< Envelope 10 Initial Level
            N10DEL = 449,     ///< Envelope 10 Delay Time
            N10ATK = 450,     ///< Envelope 10 Attack Time
            N10PK = 451,      ///< Envelope 10 Peak Level
            N10HLD = 452,     ///< Envelope 10 Hold Time
            N10DEC = 453,     ///< Envelope 10 Decay Time
            N10SUS = 454,     ///< Envelope 10 Sustain Level
            N10REL = 455,     ///< Envelope 10 Release Time
            N10FIN = 456,     ///< Envelope 10 Final Level
            N10TIN = 457,     ///< Envelope 10 Time Inaccuracy
            N10VIN = 458,     ///< Envelope 10 Level Inaccuracy

            N11SCL = 459,     ///< Envelope 11 Scale
            N11INI = 460,     ///< Envelope 11 Initial Level
            N11DEL = 461,     ///< Envelope 11 Delay Time
            N11ATK = 462,     ///< Envelope 11 Attack Time
            N11PK = 463,      ///< Envelope 11 Peak Level
            N11HLD = 464,     ///< Envelope 11 Hold Time
            N11DEC = 465,     ///< Envelope 11 Decay Time
            N11SUS = 466,     ///< Envelope 11 Sustain Level
            N11REL = 467,     ///< Envelope 11 Release Time
            N11FIN = 468,     ///< Envelope 11 Final Level
            N11TIN = 469,     ///< Envelope 11 Time Inaccuracy
            N11VIN = 470,     ///< Envelope 11 Level Inaccuracy

            N12SCL = 471,     ///< Envelope 12 Scale
            N12INI = 472,     ///< Envelope 12 Initial Level
            N12DEL = 473,     ///< Envelope 12 Delay Time
            N12ATK = 474,     ///< Envelope 12 Attack Time
            N12PK = 475,      ///< Envelope 12 Peak Level
            N12HLD = 476,     ///< Envelope 12 Hold Time
            N12DEC = 477,     ///< Envelope 12 Decay Time
            N12SUS = 478,     ///< Envelope 12 Sustain Level
            N12REL = 479,     ///< Envelope 12 Release Time
            N12FIN = 480,     ///< Envelope 12 Final Level
            ...
            L1MAX = 487,     ///< LFO 1 Maximum Value
            L1AMP = 488,     ///< LFO 1 Amplitude
            L1DST = 489,     ///< LFO 1 Distortion
            L1RND = 490,     ///< LFO 1 Randomness

            L2FRQ = 491,     ///< LFO 2 Frequency
            L2PHS = 492,     ///< LFO 2 Phase
            L2MIN = 493,     ///< LFO 2 Minimum Value
            L2MAX = 494,     ///< LFO 2 Maximum Value
            L2AMP = 495,     ///< LFO 2 Amplitude
            ...
            L3MAX = 502,     ///< LFO 3 Maximum Value
            L3AMP = 503,     ///< LFO 3 Amplitude
            L3DST = 504,     ///< LFO 3 Distortion
            L3RND = 505,     ///< LFO 3 Randomness

            L4FRQ = 506,     ///< LFO 4 Frequency
            L4PHS = 507,     ///< LFO 4 Phase
            L4MIN = 508,     ///< LFO 4 Minimum Value
            L4MAX = 509,     ///< LFO 4 Maximum Value
            L4AMP = 510,     ///< LFO 4 Amplitude
            ...
            L5MAX = 517,     ///< LFO 5 Maximum Value
            L5AMP = 518,     ///< LFO 5 Amplitude
            L5DST = 519,     ///< LFO 5 Distortion
            L5RND = 520,     ///< LFO 5 Randomness

            L6FRQ = 521,     ///< LFO 6 Frequency
            L6PHS = 522,     ///< LFO 6 Phase
            L6MIN = 523,     ///< LFO 6 Minimum Value
            L6MAX = 524,     ///< LFO 6 Maximum Value
            L6AMP = 525,     ///< LFO 6 Amplitude
            ...
            L7MAX = 532,     ///< LFO 7 Maximum Value
            L7AMP = 533,     ///< LFO 7 Amplitude
            L7DST = 534,     ///< LFO 7 Distortion
            L7RND = 535,     ///< LFO 7 Randomness

            L8FRQ = 536,     ///< LFO 8 Frequency
            L8PHS = 537,     ///< LFO 8 Phase
            L8MIN = 538,     ///< LFO 8 Minimum Value
            L8MAX = 539,     ///< LFO 8 Maximum Value
            L8AMP = 540,     ///< LFO 8 Amplitude
            L8DST = 541,     ///< LFO 8 Distortion
            L8RND = 542,     ///< LFO 8 Randomness

            MODE = 543,      ///< Mode
            MWFM = 544,      ///< Modulator Waveform
            CWFM = 545,      ///< Carrier Waveform
            MF1TYP = 546,    ///< Modulator Filter 1 Type
            MF2TYP = 547,    ///< Modulator Filter 2 Type
            ...
            L4WAV = 558,     ///< LFO 4 Waveform
            L5WAV = 559,     ///< LFO 5 Waveform
            ...
            L4CEN = 574,     ///< LFO 4 Center
            L5CEN = 575,     ///< LFO 5 Center
            L6CEN = 576,     ///< LFO 6 Center
            L7CEN = 577,     ///< LFO 7 Center
            L8CEN = 578,     ///< LFO 8 Center
            L1SYN = 579,     ///< LFO 1 Tempo Synchronization
            L2SYN = 580,     ///< LFO 2 Tempo Synchronization
            L3SYN = 581,     ///< LFO 3 Tempo Synchronization
            L4SYN = 582,     ///< LFO 4 Tempo Synchronization
            L5SYN = 583,     ///< LFO 5 Tempo Synchronization
            ...
            N4UPD = 605,     ///< Envelope 4 Update Mode
            N5UPD = 606,     ///< Envelope 5 Update Mode
            N6UPD = 607,     ///< Envelope 6 Update Mode
            N7UPD = 608,     ///< Envelope 7 Update Mode
            N8UPD = 609,     ///< Envelope 8 Update Mode
            N9UPD = 610,     ///< Envelope 9 Update Mode
            N10UPD = 611,    ///< Envelope 10 Update Mode
            ...
            L4AEN = 632,     ///< LFO 4 Amplitude Envelope
            L5AEN = 633,     ///< LFO 5 Amplitude Envelope
            L6AEN = 634,     ///< LFO 6 Amplitude Envelope
            L7AEN = 635,     ///< LFO 7 Amplitude Envelope
            L8AEN = 636,     ///< LFO 8 Amplitude Envelope
            N1SYN = 637,     ///< Envelope 1 Tempo Synchronization
            N2SYN = 638,     ///< Envelope 2 Tempo Synchronization
            N3SYN = 639,     ///< Envelope 3 Tempo Synchronization
            N4SYN = 640,     ///< Envelope 4 Tempo Synchronization
            N5SYN = 641,     ///< Envelope 5 Tempo Synchronization
            N6SYN = 642,     ///< Envelope 6 Tempo Synchronization
            N7SYN = 643,     ///< Envelope 7 Tempo Synchronization
            N8SYN = 644,     ///< Envelope 8 Tempo Synchronization
            N9SYN = 645,     ///< Envelope 9 Tempo Synchronization
            N10SYN = 646,    ///< Envelope 10 Tempo Synchronization
            N11SYN = 647,    ///< Envelope 11 Tempo Synchronization
            N12SYN = 648,    ///< Envelope 12 Tempo Synchronization
            N1ASH = 649,     ///< Envelope 1 Attack Shape
            N2ASH = 650,     ///< Envelope 2 Attack Shape
            N3ASH = 651,     ///< Envelope 3 Attack Shape
            N4ASH = 652,     ///< Envelope 4 Attack Shape
            N5ASH = 653,     ///< Envelope 5 Attack Shape
            N6ASH = 654,     ///< Envelope 6 Attack Shape
            N7ASH = 655,     ///< Envelope 7 Attack Shape
            N8ASH = 656,     ///< Envelope 8 Attack Shape
            N9ASH = 657,     ///< Envelope 9 Attack Shape
            N10ASH = 658,    ///< Envelope 10 Attack Shape
            N11ASH = 659,    ///< Envelope 11 Attack Shape
            N12ASH = 660,    ///< Envelope 12 Attack Shape
            N1DSH = 661,     ///< Envelope 1 Decay Shape
            N2DSH = 662,     ///< Envelope 2 Decay Shape
            N3DSH = 663,     ///< Envelope 3 Decay Shape
            N4DSH = 664,     ///< Envelope 4 Decay Shape
            N5DSH = 665,     ///< Envelope 5 Decay Shape
            N6DSH = 666,     ///< Envelope 6 Decay Shape
            N7DSH = 667,     ///< Envelope 7 Decay Shape
            N8DSH = 668,     ///< Envelope 8 Decay Shape
            N9DSH = 669,     ///< Envelope 9 Decay Shape
            N10DSH = 670,    ///< Envelope 10 Decay Shape
            N11DSH = 671,    ///< Envelope 11 Decay Shape
            N12DSH = 672,    ///< Envelope 12 Decay Shape
            N1RSH = 673,     ///< Envelope 1 Release Shape
            N2RSH = 674,     ///< Envelope 2 Release Shape
            N3RSH = 675,     ///< Envelope 3 Release Shape
            N4RSH = 676,     ///< Envelope 4 Release Shape
            N5RSH = 677,     ///< Envelope 5 Release Shape
            N6RSH = 678,     ///< Envelope 6 Release Shape
            N7RSH = 679,     ///< Envelope 7 Release Shape
            N8RSH = 680,     ///< Envelope 8 Release Shape
            N9RSH = 681,     ///< Envelope 9 Release Shape
            N10RSH = 682,    ///< Envelope 10 Release Shape
            N11RSH = 683,    ///< Envelope 11 Release Shape
            N12RSH = 684,    ///< Envelope 12 Release Shape
            M1DCV = 685,     ///< Macro 1 Distortion Curve
            M2DCV = 686,     ///< Macro 2 Distortion Curve
            M3DCV = 687,     ///< Macro 3 Distortion Curve
            M4DCV = 688,     ///< Macro 4 Distortion Curve
            M5DCV = 689,     ///< Macro 5 Distortion Curve
            M6DCV = 690,     ///< Macro 6 Distortion Curve
            M7DCV = 691,     ///< Macro 7 Distortion Curve
            M8DCV = 692,     ///< Macro 8 Distortion Curve
            M9DCV = 693,     ///< Macro 9 Distortion Curve
            M10DCV = 694,    ///< Macro 10 Distortion Curve
            M11DCV = 695,    ///< Macro 11 Distortion Curve
            M12DCV = 696,    ///< Macro 12 Distortion Curve
            M13DCV = 697,    ///< Macro 13 Distortion Curve
            M14DCV = 698,    ///< Macro 14 Distortion Curve
            M15DCV = 699,    ///< Macro 15 Distortion Curve
            M16DCV = 700,    ///< Macro 16 Distortion Curve
            M17DCV = 701,    ///< Macro 17 Distortion Curve
            M18DCV = 702,    ///< Macro 18 Distortion Curve
            M19DCV = 703,    ///< Macro 19 Distortion Curve
            M20DCV = 704,    ///< Macro 20 Distortion Curve
            M21DCV = 705,    ///< Macro 21 Distortion Curve
            M22DCV = 706,    ///< Macro 22 Distortion Curve
            M23DCV = 707,    ///< Macro 23 Distortion Curve
            M24DCV = 708,    ///< Macro 24 Distortion Curve
            M25DCV = 709,    ///< Macro 25 Distortion Curve
            M26DCV = 710,    ///< Macro 26 Distortion Curve
            M27DCV = 711,    ///< Macro 27 Distortion Curve
            M28DCV = 712,    ///< Macro 28 Distortion Curve
            M29DCV = 713,    ///< Macro 29 Distortion Curve
    ...
    public:
        ...
        Number discrete_param_value_to_ratio(
            ParamId const param_id,
            Byte const value
        ) const noexcept;
