...
class Synth : public Midi::EventHandler, public SignalProducer
{
    ...
    public:
        ...
        enum ParamId {
            ...
            EPFRQ = 64,      ///< Effects Phaser LFO Frequency
            EPCNTR = 65,     ///< Effects Phaser Filter Frequency Center
            EPQ = 66,        ///< Effects Phaser Filter Q Factor
            EPDPT = 67,      ///< Effects Phaser Depth
            EPDF = 68,       ///< Effects Phaser Dampening Frequency
            EPDG = 69,       ///< Effects Phaser Dampening Gain
            EPPHS = 70,      ///< Effects Phaser Stereo Phase Difference
            EPHPF = 71,      ///< Effects Phaser Highpass Frequency
            EPWET = 72,      ///< Effects Phaser Wet Volume
            EPDRY = 73,      ///< Effects Phaser Dry Volume

            ECDEL = 74,      ///< Effects Chorus Delay
            ECFRQ = 75,      ///< Effects Chorus LFO Frequency
            ECDPT = 76,      ///< Effects Chorus Depth
            ECFB = 77,       ///< Effects Chorus Feedback
            ECDF = 78,       ///< Effects Chorus Dampening Frequency
            ECDG = 79,       ///< Effects Chorus Dampening Gain
            ECWID = 80,      ///< Effects Chorus Stereo Width
            ECHPF = 81,      ///< Effects Chorus Highpass Frequency
            ECWET = 82,      ///< Effects Chorus Wet Volume
            ECDRY = 83,      ///< Effects Chorus Dry Volume

            EEDEL = 84,      ///< Effects Echo Delay
            EEFB = 85,       ///< Effects Echo Feedback
            EEDF = 86,       ///< Effects Echo Dampening Frequency
            EEDG = 87,       ///< Effects Echo Dampening Gain
            EEWID = 88,      ///< Effects Echo Stereo Width
            EEHPF = 89,      ///< Effects Echo Highpass Frequency
            EEWET = 90,      ///< Effects Echo Wet Volume
            EEDRY = 91,      ///< Effects Echo Dry Volume

            ERRS = 92,       ///< Effects Reverb Room Size
            ERDF = 93,       ///< Effects Reverb Dampening Frequency
            ERDG = 94,       ///< Effects Reverb Dampening Gain
            ERWID = 95,      ///< Effects Reverb Stereo Width
            ERHPF = 96,      ///< Effects Reverb Highpass Frequency
            ERWET = 97,      ///< Effects Reverb Wet Volume
            ERDRY = 98,      ///< Effects Reverb Dry Volume

            F1IN = 99,       ///< Flexible Controller 1 Input
            F1MIN = 100,     ///< Flexible Controller 1 Minimum Value
            F1MAX = 101,     ///< Flexible Controller 1 Maximum Value
            F1AMT = 102,     ///< Flexible Controller 1 Amount
            F1DST = 103,     ///< Flexible Controller 1 Distortion
            F1RND = 104,     ///< Flexible Controller 1 Randomness

            F2IN = 105,      ///< Flexible Controller 2 Input
            F2MIN = 106,     ///< Flexible Controller 2 Minimum Value
            F2MAX = 107,     ///< Flexible Controller 2 Maximum Value
            F2AMT = 108,     ///< Flexible Controller 2 Amount
            F2DST = 109,     ///< Flexible Controller 2 Distortion
            F2RND = 110,     ///< Flexible Controller 2 Randomness

            F3IN = 111,      ///< Flexible Controller 3 Input
            F3MIN = 112,     ///< Flexible Controller 3 Minimum Value
            F3MAX = 113,     ///< Flexible Controller 3 Maximum Value
            F3AMT = 114,     ///< Flexible Controller 3 Amount
            F3DST = 115,     ///< Flexible Controller 3 Distortion
            F3RND = 116,     ///< Flexible Controller 3 Randomness

            F4IN = 117,      ///< Flexible Controller 4 Input
            F4MIN = 118,     ///< Flexible Controller 4 Minimum Value
            F4MAX = 119,     ///< Flexible Controller 4 Maximum Value
            F4AMT = 120,     ///< Flexible Controller 4 Amount
            F4DST = 121,     ///< Flexible Controller 4 Distortion
            F4RND = 122,     ///< Flexible Controller 4 Randomness

            F5IN = 123,      ///< Flexible Controller 5 Input
            F5MIN = 124,     ///< Flexible Controller 5 Minimum Value
            F5MAX = 125,     ///< Flexible Controller 5 Maximum Value
            F5AMT = 126,     ///< Flexible Controller 5 Amount
            F5DST = 127,     ///< Flexible Controller 5 Distortion
            F5RND = 128,     ///< Flexible Controller 5 Randomness

            F6IN = 129,      ///< Flexible Controller 6 Input
            F6MIN = 130,     ///< Flexible Controller 6 Minimum Value
            F6MAX = 131,     ///< Flexible Controller 6 Maximum Value
            F6AMT = 132,     ///< Flexible Controller 6 Amount
            F6DST = 133,     ///< Flexible Controller 6 Distortion
            F6RND = 134,     ///< Flexible Controller 6 Randomness

            F7IN = 135,      ///< Flexible Controller 7 Input
            F7MIN = 136,     ///< Flexible Controller 7 Minimum Value
            F7MAX = 137,     ///< Flexible Controller 7 Maximum Value
            F7AMT = 138,     ///< Flexible Controller 7 Amount
            F7DST = 139,     ///< Flexible Controller 7 Distortion
            F7RND = 140,     ///< Flexible Controller 7 Randomness

            F8IN = 141,      ///< Flexible Controller 8 Input
            F8MIN = 142,     ///< Flexible Controller 8 Minimum Value
            F8MAX = 143,     ///< Flexible Controller 8 Maximum Value
            F8AMT = 144,     ///< Flexible Controller 8 Amount
            F8DST = 145,     ///< Flexible Controller 8 Distortion
            F8RND = 146,     ///< Flexible Controller 8 Randomness

            F9IN = 147,      ///< Flexible Controller 9 Input
            F9MIN = 148,     ///< Flexible Controller 9 Minimum Value
            F9MAX = 149,     ///< Flexible Controller 9 Maximum Value
            F9AMT = 150,     ///< Flexible Controller 9 Amount
            F9DST = 151,     ///< Flexible Controller 9 Distortion
            F9RND = 152,     ///< Flexible Controller 9 Randomness

            F10IN = 153,     ///< Flexible Controller 10 Input
            F10MIN = 154,    ///< Flexible Controller 10 Minimum Value
            F10MAX = 155,    ///< Flexible Controller 10 Maximum Value
            F10AMT = 156,    ///< Flexible Controller 10 Amount
            F10DST = 157,    ///< Flexible Controller 10 Distortion
            F10RND = 158,    ///< Flexible Controller 10 Randomness

            N1AMT = 159,     ///< Envelope 1 Amount
            N1INI = 160,     ///< Envelope 1 Initial Level
            N1DEL = 161,     ///< Envelope 1 Delay Time
            N1ATK = 162,     ///< Envelope 1 Attack Time
            N1PK = 163,      ///< Envelope 1 Peak Level
            N1HLD = 164,     ///< Envelope 1 Hold Time
            N1DEC = 165,     ///< Envelope 1 Decay Time
            N1SUS = 166,     ///< Envelope 1 Sustain Level
            N1REL = 167,     ///< Envelope 1 Release Time
            N1FIN = 168,     ///< Envelope 1 Final Level

            N2AMT = 169,     ///< Envelope 2 Amount
            N2INI = 170,     ///< Envelope 2 Initial Level
            N2DEL = 171,     ///< Envelope 2 Delay Time
            N2ATK = 172,     ///< Envelope 2 Attack Time
            N2PK = 173,      ///< Envelope 2 Peak Level
            N2HLD = 174,     ///< Envelope 2 Hold Time
            N2DEC = 175,     ///< Envelope 2 Decay Time
            N2SUS = 176,     ///< Envelope 2 Sustain Level
            N2REL = 177,     ///< Envelope 2 Release Time
            N2FIN = 178,     ///< Envelope 2 Final Level

            N3AMT = 179,     ///< Envelope 3 Amount
            N3INI = 180,     ///< Envelope 3 Initial Level
            N3DEL = 181,     ///< Envelope 3 Delay Time
            N3ATK = 182,     ///< Envelope 3 Attack Time
            N3PK = 183,      ///< Envelope 3 Peak Level
            N3HLD = 184,     ///< Envelope 3 Hold Time
            N3DEC = 185,     ///< Envelope 3 Decay Time
            N3SUS = 186,     ///< Envelope 3 Sustain Level
            N3REL = 187,     ///< Envelope 3 Release Time
            N3FIN = 188,     ///< Envelope 3 Final Level

            N4AMT = 189,     ///< Envelope 4 Amount
            N4INI = 190,     ///< Envelope 4 Initial Level
            N4DEL = 191,     ///< Envelope 4 Delay Time
            N4ATK = 192,     ///< Envelope 4 Attack Time
            N4PK = 193,      ///< Envelope 4 Peak Level
            N4HLD = 194,     ///< Envelope 4 Hold Time
            N4DEC = 195,     ///< Envelope 4 Decay Time
            N4SUS = 196,     ///< Envelope 4 Sustain Level
            N4REL = 197,     ///< Envelope 4 Release Time
            N4FIN = 198,     ///< Envelope 4 Final Level

            N5AMT = 199,     ///< Envelope 5 Amount
            N5INI = 200,     ///< Envelope 5 Initial Level
            N5DEL = 201,     ///< Envelope 5 Delay Time
            N5ATK = 202,     ///< Envelope 5 Attack Time
            N5PK = 203,      ///< Envelope 5 Peak Level
            N5HLD = 204,     ///< Envelope 5 Hold Time
            N5DEC = 205,     ///< Envelope 5 Decay Time
            N5SUS = 206,     ///< Envelope 5 Sustain Level
            N5REL = 207,     ///< Envelope 5 Release Time
            N5FIN = 208,     ///< Envelope 5 Final Level

            N6AMT = 209,     ///< Envelope 6 Amount
            N6INI = 210,     ///< Envelope 6 Initial Level
            N6DEL = 211,     ///< Envelope 6 Delay Time
            N6ATK = 212,     ///< Envelope 6 Attack Time
            N6PK = 213,      ///< Envelope 6 Peak Level
            N6HLD = 214,     ///< Envelope 6 Hold Time
            N6DEC = 215,     ///< Envelope 6 Decay Time
            N6SUS = 216,     ///< Envelope 6 Sustain Level
            N6REL = 217,     ///< Envelope 6 Release Time
            N6FIN = 218,     ///< Envelope 6 Final Level

            L1FRQ = 219,     ///< LFO 1 Frequency
            L1PHS = 220,     ///< LFO 1 Phase
            L1MIN = 221,     ///< LFO 1 Minimum Value
            L1MAX = 222,     ///< LFO 1 Maximum Value
            L1AMT = 223,     ///< LFO 1 Amount
            L1DST = 224,     ///< LFO 1 Distortion
            L1RND = 225,     ///< LFO 1 Randomness

            L2FRQ = 226,     ///< LFO 2 Frequency
            L2PHS = 227,     ///< LFO 2 Phase
            L2MIN = 228,     ///< LFO 2 Minimum Value
            L2MAX = 229,     ///< LFO 2 Maximum Value
            L2AMT = 230,     ///< LFO 2 Amount
            L2DST = 231,     ///< LFO 2 Distortion
            L2RND = 232,     ///< LFO 2 Randomness

            L3FRQ = 233,     ///< LFO 3 Frequency
            L3PHS = 234,     ///< LFO 3 Phase
            L3MIN = 235,     ///< LFO 3 Minimum Value
            L3MAX = 236,     ///< LFO 3 Maximum Value
            L3AMT = 237,     ///< LFO 3 Amount
            L3DST = 238,     ///< LFO 3 Distortion
            L3RND = 239,     ///< LFO 3 Randomness

            L4FRQ = 240,     ///< LFO 4 Frequency
            L4PHS = 241,     ///< LFO 4 Phase
            L4MIN = 242,     ///< LFO 4 Minimum Value
            L4MAX = 243,     ///< LFO 4 Maximum Value
            L4AMT = 244,     ///< LFO 4 Amount
            L4DST = 245,     ///< LFO 4 Distortion
            L4RND = 246,     ///< LFO 4 Randomness

            L5FRQ = 247,     ///< LFO 5 Frequency
            L5PHS = 248,     ///< LFO 5 Phase
            L5MIN = 249,     ///< LFO 5 Minimum Value
            L5MAX = 250,     ///< LFO 5 Maximum Value
            L5AMT = 251,     ///< LFO 5 Amount
            L5DST = 252,     ///< LFO 5 Distortion
            L5RND = 253,     ///< LFO 5 Randomness

            L6FRQ = 254,     ///< LFO 6 Frequency
            L6PHS = 255,     ///< LFO 6 Phase
            L6MIN = 256,     ///< LFO 6 Minimum Value
            L6MAX = 257,     ///< LFO 6 Maximum Value
            L6AMT = 258,     ///< LFO 6 Amount
            L6DST = 259,     ///< LFO 6 Distortion
            L6RND = 260,     ///< LFO 6 Randomness

            L7FRQ = 261,     ///< LFO 7 Frequency
            L7PHS = 262,     ///< LFO 7 Phase
            L7MIN = 263,     ///< LFO 7 Minimum Value
            L7MAX = 264,     ///< LFO 7 Maximum Value
            L7AMT = 265,     ///< LFO 7 Amount
            L7DST = 266,     ///< LFO 7 Distortion
            L7RND = 267,     ///< LFO 7 Randomness

            L8FRQ = 268,     ///< LFO 8 Frequency
            L8PHS = 269,     ///< LFO 8 Phase
            L8MIN = 270,     ///< LFO 8 Minimum Value
            L8MAX = 271,     ///< LFO 8 Maximum Value
            L8AMT = 272,     ///< LFO 8 Amount
            L8DST = 273,     ///< LFO 8 Distortion
            L8RND = 274,     ///< LFO 8 Randomness

            MODE = 275,      ///< Mode

            MWAV = 276,      ///< Modulator Waveform
            CWAV = 277,      ///< Carrier Waveform

            MF1TYP = 278,    ///< Modulator Filter 1 Type
            MF2TYP = 279,    ///< Modulator Filter 2 Type
            CF1TYP = 280,    ///< Carrier Filter 1 Type
            CF2TYP = 281,    ///< Carrier Filter 2 Type
            EF1TYP = 282,    ///< Effects Filter 1 Type
            EF2TYP = 283,    ///< Effects Filter 2 Type

            L1WAV = 284,     ///< LFO 1 Waveform
            L2WAV = 285,     ///< LFO 2 Waveform
            L3WAV = 286,     ///< LFO 3 Waveform
            L4WAV = 287,     ///< LFO 4 Waveform
            L5WAV = 288,     ///< LFO 5 Waveform
            L6WAV = 289,     ///< LFO 6 Waveform
            L7WAV = 290,     ///< LFO 7 Waveform
            L8WAV = 291,     ///< LFO 8 Waveform

            L1CEN = 292,     ///< LFO 1 Center
            L2CEN = 293,     ///< LFO 2 Center
            L3CEN = 294,     ///< LFO 3 Center
            L4CEN = 295,     ///< LFO 4 Center
            L5CEN = 296,     ///< LFO 5 Center
            L6CEN = 297,     ///< LFO 6 Center
            L7CEN = 298,     ///< LFO 7 Center
            L8CEN = 299,     ///< LFO 8 Center

            L1SYN = 300,     ///< LFO 1 Tempo Synchronization
            L2SYN = 301,     ///< LFO 2 Tempo Synchronization
            L3SYN = 302,     ///< LFO 3 Tempo Synchronization
            L4SYN = 303,     ///< LFO 4 Tempo Synchronization
            L5SYN = 304,     ///< LFO 5 Tempo Synchronization
            L6SYN = 305,     ///< LFO 6 Tempo Synchronization
            L7SYN = 306,     ///< LFO 7 Tempo Synchronization
            L8SYN = 307,     ///< LFO 8 Tempo Synchronization

            EPSYN = 308,     ///< Effects Phaser Tempo Synchronization

            ECSYN = 309,     ///< Effects Chorus Tempo Synchronization

            EESYN = 310,     ///< Effects Echo Tempo Synchronization

            MF1LOG = 311,    ///< Modulator Filter 1 Logarithmic Frequency
            MF2LOG = 312,    ///< Modulator Filter 2 Logarithmic Frequency
            CF1LOG = 313,    ///< Carrier Filter 1 Logarithmic Frequency
            CF2LOG = 314,    ///< Carrier Filter 2 Logarithmic Frequency
            EF1LOG = 315,    ///< Effects Filter 1 Logarithmic Frequency
            EF2LOG = 316,    ///< Effects Filter 2 Logarithmic Frequency
            EPLOG = 317,     ///< Effects Phaser Logarithmic Frequency Center

            N1DYN = 318,     ///< Envelope 1 Dynamic
            N2DYN = 319,     ///< Envelope 2 Dynamic
            N3DYN = 320,     ///< Envelope 3 Dynamic
            N4DYN = 321,     ///< Envelope 4 Dynamic
            N5DYN = 322,     ///< Envelope 5 Dynamic
            N6DYN = 323,     ///< Envelope 6 Dynamic
