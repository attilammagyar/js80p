...
class Synth : public Midi::EventHandler, public SignalProducer
{
    ...
    public:
        ...
        enum ParamId {
            ...
            EVV = 64,        ///< Effects Volume

            ECDEL = 65,      ///< Effects Chorus Delay
            ECFRQ = 66,      ///< Effects Chorus LFO Frequency
            ECDPT = 67,      ///< Effects Chorus Depth
            ECFB = 68,       ///< Effects Chorus Feedback
            ECDF = 69,       ///< Effects Chorus Dampening Frequency
            ECDG = 70,       ///< Effects Chorus Dampening Gain
            ECWID = 71,      ///< Effects Chorus Stereo Width
            ECHPF = 72,      ///< Effects Chorus Highpass Frequency
            ECWET = 73,      ///< Effects Chorus Wet Volume
            ECDRY = 74,      ///< Effects Chorus Dry Volume

            EEDEL = 75,      ///< Effects Echo Delay
            EEFB = 76,       ///< Effects Echo Feedback
            EEDF = 77,       ///< Effects Echo Dampening Frequency
            EEDG = 78,       ///< Effects Echo Dampening Gain
            EEWID = 79,      ///< Effects Echo Stereo Width
            EEHPF = 80,      ///< Effects Echo Highpass Frequency
            EESTH = 81,      ///< Effects Echo Side-Chain Compression Threshold
            EESAT = 82,      ///< Effects Echo Side-Chain Compression Attack Time
            EESRL = 83,      ///< Effects Echo Side-Chain Compression Release Time
            EESG = 84,       ///< Effects Echo Side-Chain Compression Gain Reduction
            EEWET = 85,      ///< Effects Echo Wet Volume
            EEDRY = 86,      ///< Effects Echo Dry Volume

            ERRS = 87,       ///< Effects Reverb Room Size
            ERDF = 88,       ///< Effects Reverb Dampening Frequency
            ERDG = 89,       ///< Effects Reverb Dampening Gain
            ERWID = 90,      ///< Effects Reverb Stereo Width
            ERHPF = 91,      ///< Effects Reverb Highpass Frequency
            ERSTH = 92,      ///< Effects Reverb Side-Chain Compression Threshold
            ERSAT = 93,      ///< Effects Reverb Side-Chain Compression Attack Time
            ERSRL = 94,      ///< Effects Reverb Side-Chain Compression Release Time
            ERSG = 95,       ///< Effects Reverb Side-Chain Compression Gain Reduction
            ERWET = 96,      ///< Effects Reverb Wet Volume
            ERDRY = 97,      ///< Effects Reverb Dry Volume

            M1IN = 98,       ///< Macro 1 Input
            M1MIN = 99,      ///< Macro 1 Minimum Value
            M1MAX = 100,     ///< Macro 1 Maximum Value
            M1AMT = 101,     ///< Macro 1 Amount
            M1DST = 102,     ///< Macro 1 Distortion
            M1RND = 103,     ///< Macro 1 Randomness

            M2IN = 104,      ///< Macro 2 Input
            M2MIN = 105,     ///< Macro 2 Minimum Value
            M2MAX = 106,     ///< Macro 2 Maximum Value
            M2AMT = 107,     ///< Macro 2 Amount
            M2DST = 108,     ///< Macro 2 Distortion
            M2RND = 109,     ///< Macro 2 Randomness

            M3IN = 110,      ///< Macro 3 Input
            M3MIN = 111,     ///< Macro 3 Minimum Value
            M3MAX = 112,     ///< Macro 3 Maximum Value
            M3AMT = 113,     ///< Macro 3 Amount
            M3DST = 114,     ///< Macro 3 Distortion
            M3RND = 115,     ///< Macro 3 Randomness

            M4IN = 116,      ///< Macro 4 Input
            M4MIN = 117,     ///< Macro 4 Minimum Value
            M4MAX = 118,     ///< Macro 4 Maximum Value
            M4AMT = 119,     ///< Macro 4 Amount
            M4DST = 120,     ///< Macro 4 Distortion
            M4RND = 121,     ///< Macro 4 Randomness

            M5IN = 122,      ///< Macro 5 Input
            M5MIN = 123,     ///< Macro 5 Minimum Value
            M5MAX = 124,     ///< Macro 5 Maximum Value
            M5AMT = 125,     ///< Macro 5 Amount
            M5DST = 126,     ///< Macro 5 Distortion
            M5RND = 127,     ///< Macro 5 Randomness

            M6IN = 128,      ///< Macro 6 Input
            M6MIN = 129,     ///< Macro 6 Minimum Value
            M6MAX = 130,     ///< Macro 6 Maximum Value
            M6AMT = 131,     ///< Macro 6 Amount
            M6DST = 132,     ///< Macro 6 Distortion
            M6RND = 133,     ///< Macro 6 Randomness

            M7IN = 134,      ///< Macro 7 Input
            M7MIN = 135,     ///< Macro 7 Minimum Value
            M7MAX = 136,     ///< Macro 7 Maximum Value
            M7AMT = 137,     ///< Macro 7 Amount
            M7DST = 138,     ///< Macro 7 Distortion
            M7RND = 139,     ///< Macro 7 Randomness

            M8IN = 140,      ///< Macro 8 Input
            M8MIN = 141,     ///< Macro 8 Minimum Value
            M8MAX = 142,     ///< Macro 8 Maximum Value
            M8AMT = 143,     ///< Macro 8 Amount
            M8DST = 144,     ///< Macro 8 Distortion
            M8RND = 145,     ///< Macro 8 Randomness

            M9IN = 146,      ///< Macro 9 Input
            M9MIN = 147,     ///< Macro 9 Minimum Value
            M9MAX = 148,     ///< Macro 9 Maximum Value
            M9AMT = 149,     ///< Macro 9 Amount
            M9DST = 150,     ///< Macro 9 Distortion
            M9RND = 151,     ///< Macro 9 Randomness

            M10IN = 152,     ///< Macro 10 Input
            M10MIN = 153,    ///< Macro 10 Minimum Value
            M10MAX = 154,    ///< Macro 10 Maximum Value
            M10AMT = 155,    ///< Macro 10 Amount
            M10DST = 156,    ///< Macro 10 Distortion
            M10RND = 157,    ///< Macro 10 Randomness

            M11IN = 158,     ///< Macro 11 Input
            M11MIN = 159,    ///< Macro 11 Minimum Value
            M11MAX = 160,    ///< Macro 11 Maximum Value
            M11AMT = 161,    ///< Macro 11 Amount
            M11DST = 162,    ///< Macro 11 Distortion
            M11RND = 163,    ///< Macro 11 Randomness

            M12IN = 164,     ///< Macro 12 Input
            M12MIN = 165,    ///< Macro 12 Minimum Value
            M12MAX = 166,    ///< Macro 12 Maximum Value
            M12AMT = 167,    ///< Macro 12 Amount
            M12DST = 168,    ///< Macro 12 Distortion
            M12RND = 169,    ///< Macro 12 Randomness

            M13IN = 170,     ///< Macro 13 Input
            M13MIN = 171,    ///< Macro 13 Minimum Value
            M13MAX = 172,    ///< Macro 13 Maximum Value
            M13AMT = 173,    ///< Macro 13 Amount
            M13DST = 174,    ///< Macro 13 Distortion
            M13RND = 175,    ///< Macro 13 Randomness

            M14IN = 176,     ///< Macro 14 Input
            M14MIN = 177,    ///< Macro 14 Minimum Value
            M14MAX = 178,    ///< Macro 14 Maximum Value
            M14AMT = 179,    ///< Macro 14 Amount
            M14DST = 180,    ///< Macro 14 Distortion
            M14RND = 181,    ///< Macro 14 Randomness

            M15IN = 182,     ///< Macro 15 Input
            M15MIN = 183,    ///< Macro 15 Minimum Value
            M15MAX = 184,    ///< Macro 15 Maximum Value
            M15AMT = 185,    ///< Macro 15 Amount
            M15DST = 186,    ///< Macro 15 Distortion
            M15RND = 187,    ///< Macro 15 Randomness

            M16IN = 188,     ///< Macro 16 Input
            M16MIN = 189,    ///< Macro 16 Minimum Value
            M16MAX = 190,    ///< Macro 16 Maximum Value
            M16AMT = 191,    ///< Macro 16 Amount
            M16DST = 192,    ///< Macro 16 Distortion
            M16RND = 193,    ///< Macro 16 Randomness

            M17IN = 194,     ///< Macro 17 Input
            M17MIN = 195,    ///< Macro 17 Minimum Value
            M17MAX = 196,    ///< Macro 17 Maximum Value
            M17AMT = 197,    ///< Macro 17 Amount
            M17DST = 198,    ///< Macro 17 Distortion
            M17RND = 199,    ///< Macro 17 Randomness

            M18IN = 200,     ///< Macro 18 Input
            M18MIN = 201,    ///< Macro 18 Minimum Value
            M18MAX = 202,    ///< Macro 18 Maximum Value
            M18AMT = 203,    ///< Macro 18 Amount
            M18DST = 204,    ///< Macro 18 Distortion
            M18RND = 205,    ///< Macro 18 Randomness

            M19IN = 206,     ///< Macro 19 Input
            M19MIN = 207,    ///< Macro 19 Minimum Value
            M19MAX = 208,    ///< Macro 19 Maximum Value
            M19AMT = 209,    ///< Macro 19 Amount
            M19DST = 210,    ///< Macro 19 Distortion
            M19RND = 211,    ///< Macro 19 Randomness

            M20IN = 212,     ///< Macro 20 Input
            M20MIN = 213,    ///< Macro 20 Minimum Value
            M20MAX = 214,    ///< Macro 20 Maximum Value
            M20AMT = 215,    ///< Macro 20 Amount
            M20DST = 216,    ///< Macro 20 Distortion
            M20RND = 217,    ///< Macro 20 Randomness

            N1AMT = 218,     ///< Envelope 1 Amount
            N1INI = 219,     ///< Envelope 1 Initial Level
            N1DEL = 220,     ///< Envelope 1 Delay Time
            N1ATK = 221,     ///< Envelope 1 Attack Time
            N1PK = 222,      ///< Envelope 1 Peak Level
            N1HLD = 223,     ///< Envelope 1 Hold Time
            N1DEC = 224,     ///< Envelope 1 Decay Time
            N1SUS = 225,     ///< Envelope 1 Sustain Level
            N1REL = 226,     ///< Envelope 1 Release Time
            N1FIN = 227,     ///< Envelope 1 Final Level

            N2AMT = 228,     ///< Envelope 2 Amount
            N2INI = 229,     ///< Envelope 2 Initial Level
            N2DEL = 230,     ///< Envelope 2 Delay Time
            N2ATK = 231,     ///< Envelope 2 Attack Time
            N2PK = 232,      ///< Envelope 2 Peak Level
            N2HLD = 233,     ///< Envelope 2 Hold Time
            N2DEC = 234,     ///< Envelope 2 Decay Time
            N2SUS = 235,     ///< Envelope 2 Sustain Level
            N2REL = 236,     ///< Envelope 2 Release Time
            N2FIN = 237,     ///< Envelope 2 Final Level

            N3AMT = 238,     ///< Envelope 3 Amount
            N3INI = 239,     ///< Envelope 3 Initial Level
            N3DEL = 240,     ///< Envelope 3 Delay Time
            N3ATK = 241,     ///< Envelope 3 Attack Time
            N3PK = 242,      ///< Envelope 3 Peak Level
            N3HLD = 243,     ///< Envelope 3 Hold Time
            N3DEC = 244,     ///< Envelope 3 Decay Time
            N3SUS = 245,     ///< Envelope 3 Sustain Level
            N3REL = 246,     ///< Envelope 3 Release Time
            N3FIN = 247,     ///< Envelope 3 Final Level

            N4AMT = 248,     ///< Envelope 4 Amount
            N4INI = 249,     ///< Envelope 4 Initial Level
            N4DEL = 250,     ///< Envelope 4 Delay Time
            N4ATK = 251,     ///< Envelope 4 Attack Time
            N4PK = 252,      ///< Envelope 4 Peak Level
            N4HLD = 253,     ///< Envelope 4 Hold Time
            N4DEC = 254,     ///< Envelope 4 Decay Time
            N4SUS = 255,     ///< Envelope 4 Sustain Level
            N4REL = 256,     ///< Envelope 4 Release Time
            N4FIN = 257,     ///< Envelope 4 Final Level

            N5AMT = 258,     ///< Envelope 5 Amount
            N5INI = 259,     ///< Envelope 5 Initial Level
            N5DEL = 260,     ///< Envelope 5 Delay Time
            N5ATK = 261,     ///< Envelope 5 Attack Time
            N5PK = 262,      ///< Envelope 5 Peak Level
            N5HLD = 263,     ///< Envelope 5 Hold Time
            N5DEC = 264,     ///< Envelope 5 Decay Time
            N5SUS = 265,     ///< Envelope 5 Sustain Level
            N5REL = 266,     ///< Envelope 5 Release Time
            N5FIN = 267,     ///< Envelope 5 Final Level

            N6AMT = 268,     ///< Envelope 6 Amount
            N6INI = 269,     ///< Envelope 6 Initial Level
            N6DEL = 270,     ///< Envelope 6 Delay Time
            N6ATK = 271,     ///< Envelope 6 Attack Time
            N6PK = 272,      ///< Envelope 6 Peak Level
            N6HLD = 273,     ///< Envelope 6 Hold Time
            N6DEC = 274,     ///< Envelope 6 Decay Time
            N6SUS = 275,     ///< Envelope 6 Sustain Level
            N6REL = 276,     ///< Envelope 6 Release Time
            N6FIN = 277,     ///< Envelope 6 Final Level

            L1FRQ = 278,     ///< LFO 1 Frequency
            L1PHS = 279,     ///< LFO 1 Phase
            L1MIN = 280,     ///< LFO 1 Minimum Value
            L1MAX = 281,     ///< LFO 1 Maximum Value
            L1AMT = 282,     ///< LFO 1 Amount
            L1DST = 283,     ///< LFO 1 Distortion
            L1RND = 284,     ///< LFO 1 Randomness

            L2FRQ = 285,     ///< LFO 2 Frequency
            L2PHS = 286,     ///< LFO 2 Phase
            L2MIN = 287,     ///< LFO 2 Minimum Value
            L2MAX = 288,     ///< LFO 2 Maximum Value
            L2AMT = 289,     ///< LFO 2 Amount
            L2DST = 290,     ///< LFO 2 Distortion
            L2RND = 291,     ///< LFO 2 Randomness

            L3FRQ = 292,     ///< LFO 3 Frequency
            L3PHS = 293,     ///< LFO 3 Phase
            L3MIN = 294,     ///< LFO 3 Minimum Value
            L3MAX = 295,     ///< LFO 3 Maximum Value
            L3AMT = 296,     ///< LFO 3 Amount
            L3DST = 297,     ///< LFO 3 Distortion
            L3RND = 298,     ///< LFO 3 Randomness

            L4FRQ = 299,     ///< LFO 4 Frequency
            L4PHS = 300,     ///< LFO 4 Phase
            L4MIN = 301,     ///< LFO 4 Minimum Value
            L4MAX = 302,     ///< LFO 4 Maximum Value
            L4AMT = 303,     ///< LFO 4 Amount
            L4DST = 304,     ///< LFO 4 Distortion
            L4RND = 305,     ///< LFO 4 Randomness

            L5FRQ = 306,     ///< LFO 5 Frequency
            L5PHS = 307,     ///< LFO 5 Phase
            L5MIN = 308,     ///< LFO 5 Minimum Value
            L5MAX = 309,     ///< LFO 5 Maximum Value
            L5AMT = 310,     ///< LFO 5 Amount
            L5DST = 311,     ///< LFO 5 Distortion
            L5RND = 312,     ///< LFO 5 Randomness

            L6FRQ = 313,     ///< LFO 6 Frequency
            L6PHS = 314,     ///< LFO 6 Phase
            L6MIN = 315,     ///< LFO 6 Minimum Value
            L6MAX = 316,     ///< LFO 6 Maximum Value
            L6AMT = 317,     ///< LFO 6 Amount
            L6DST = 318,     ///< LFO 6 Distortion
            L6RND = 319,     ///< LFO 6 Randomness

            L7FRQ = 320,     ///< LFO 7 Frequency
            L7PHS = 321,     ///< LFO 7 Phase
            L7MIN = 322,     ///< LFO 7 Minimum Value
            L7MAX = 323,     ///< LFO 7 Maximum Value
            L7AMT = 324,     ///< LFO 7 Amount
            L7DST = 325,     ///< LFO 7 Distortion
            L7RND = 326,     ///< LFO 7 Randomness

            L8FRQ = 327,     ///< LFO 8 Frequency
            L8PHS = 328,     ///< LFO 8 Phase
            L8MIN = 329,     ///< LFO 8 Minimum Value
            L8MAX = 330,     ///< LFO 8 Maximum Value
            L8AMT = 331,     ///< LFO 8 Amount
            L8DST = 332,     ///< LFO 8 Distortion
            L8RND = 333,     ///< LFO 8 Randomness

            MODE = 334,      ///< Mode

            MWAV = 335,      ///< Modulator Waveform
            CWAV = 336,      ///< Carrier Waveform

            MF1TYP = 337,    ///< Modulator Filter 1 Type
            MF2TYP = 338,    ///< Modulator Filter 2 Type
            CF1TYP = 339,    ///< Carrier Filter 1 Type
            CF2TYP = 340,    ///< Carrier Filter 2 Type
            EF1TYP = 341,    ///< Effects Filter 1 Type
            EF2TYP = 342,    ///< Effects Filter 2 Type

            L1WAV = 343,     ///< LFO 1 Waveform
            L2WAV = 344,     ///< LFO 2 Waveform
            L3WAV = 345,     ///< LFO 3 Waveform
            L4WAV = 346,     ///< LFO 4 Waveform
            L5WAV = 347,     ///< LFO 5 Waveform
            L6WAV = 348,     ///< LFO 6 Waveform
            L7WAV = 349,     ///< LFO 7 Waveform
            L8WAV = 350,     ///< LFO 8 Waveform

            L1CEN = 351,     ///< LFO 1 Center
            L2CEN = 352,     ///< LFO 2 Center
            L3CEN = 353,     ///< LFO 3 Center
            L4CEN = 354,     ///< LFO 4 Center
            L5CEN = 355,     ///< LFO 5 Center
            L6CEN = 356,     ///< LFO 6 Center
            L7CEN = 357,     ///< LFO 7 Center
            L8CEN = 358,     ///< LFO 8 Center

            L1SYN = 359,     ///< LFO 1 Tempo Synchronization
            L2SYN = 360,     ///< LFO 2 Tempo Synchronization
            L3SYN = 361,     ///< LFO 3 Tempo Synchronization
            L4SYN = 362,     ///< LFO 4 Tempo Synchronization
            L5SYN = 363,     ///< LFO 5 Tempo Synchronization
            L6SYN = 364,     ///< LFO 6 Tempo Synchronization
            L7SYN = 365,     ///< LFO 7 Tempo Synchronization
            L8SYN = 366,     ///< LFO 8 Tempo Synchronization

            ECSYN = 367,     ///< Effects Chorus Tempo Synchronization

            EESYN = 368,     ///< Effects Echo Tempo Synchronization

            MF1LOG = 369,    ///< Modulator Filter 1 Logarithmic Frequency
            MF2LOG = 370,    ///< Modulator Filter 2 Logarithmic Frequency
            CF1LOG = 371,    ///< Carrier Filter 1 Logarithmic Frequency
            CF2LOG = 372,    ///< Carrier Filter 2 Logarithmic Frequency
            EF1LOG = 373,    ///< Effects Filter 1 Logarithmic Frequency
            EF2LOG = 374,    ///< Effects Filter 2 Logarithmic Frequency
            ECLOG = 375,     ///< Effects Chorus Logarithmic Filter Frequencies
            EELOG = 376,     ///< Effects Echo Logarithmic Filter Frequencies
            ERLOG = 377,     ///< Effects Reverb Logarithmic Filter Frequencies

            N1DYN = 378,     ///< Envelope 1 Dynamic
            N2DYN = 379,     ///< Envelope 2 Dynamic
            N3DYN = 380,     ///< Envelope 3 Dynamic
            N4DYN = 381,     ///< Envelope 4 Dynamic
            N5DYN = 382,     ///< Envelope 5 Dynamic
            N6DYN = 383,     ///< Envelope 6 Dynamic
