...
class Synth : public Midi::EventHandler, public SignalProducer
{
    ...
    public:
        ...
        enum ParamId {
            ...
            L1CEN = 450,     ///< LFO 1 Center
            L2CEN = 451,     ///< LFO 2 Center
            L3CEN = 452,     ///< LFO 3 Center
            L4CEN = 453,     ///< LFO 4 Center
            L5CEN = 454,     ///< LFO 5 Center
            L6CEN = 455,     ///< LFO 6 Center
            L7CEN = 456,     ///< LFO 7 Center
            L8CEN = 457,     ///< LFO 8 Center
            L1SYN = 458,     ///< LFO 1 Tempo Synchronization
            L2SYN = 459,     ///< LFO 2 Tempo Synchronization
            L3SYN = 460,     ///< LFO 3 Tempo Synchronization
            L4SYN = 461,     ///< LFO 4 Tempo Synchronization
            L5SYN = 462,     ///< LFO 5 Tempo Synchronization
            L6SYN = 463,     ///< LFO 6 Tempo Synchronization
            L7SYN = 464,     ///< LFO 7 Tempo Synchronization
            L8SYN = 465,     ///< LFO 8 Tempo Synchronization
            ECSYN = 466,     ///< Effects Chorus Tempo Synchronization
            EESYN = 467,     ///< Effects Echo Tempo Synchronization
            MF1LOG = 468,    ///< Modulator Filter 1 Logarithmic Frequency
            MF2LOG = 469,    ///< Modulator Filter 2 Logarithmic Frequency
            CF1LOG = 470,    ///< Carrier Filter 1 Logarithmic Frequency
            CF2LOG = 471,    ///< Carrier Filter 2 Logarithmic Frequency
            EF1LOG = 472,    ///< Effects Filter 1 Logarithmic Frequency
            EF2LOG = 473,    ///< Effects Filter 2 Logarithmic Frequency
            ECLOG = 474,     ///< Effects Chorus Logarithmic Filter Frequencies
            EELOG = 475,     ///< Effects Echo Logarithmic Filter Frequencies
            ERLOG = 476,     ///< Effects Reverb Logarithmic Filter Frequencies
            N1DYN = 477,     ///< Envelope 1 Dynamic
            N2DYN = 478,     ///< Envelope 2 Dynamic
            N3DYN = 479,     ///< Envelope 3 Dynamic
            N4DYN = 480,     ///< Envelope 4 Dynamic
            N5DYN = 481,     ///< Envelope 5 Dynamic
            N6DYN = 482,     ///< Envelope 6 Dynamic
            N7DYN = 483,     ///< Envelope 7 Dynamic
            N8DYN = 484,     ///< Envelope 8 Dynamic
            N9DYN = 485,     ///< Envelope 9 Dynamic
            N10DYN = 486,     ///< Envelope 10 Dynamic
            N11DYN = 487,     ///< Envelope 11 Dynamic
            N12DYN = 488,     ///< Envelope 12 Dynamic
            POLY = 489,      ///< Polyphonic
            ERTYP = 490,     ///< Effects Reverb Type
            ECTYP = 491,     ///< Effects Chorus Type
            MTUN = 492,      ///< Modulator Tuning
            CTUN = 493,      ///< Carrier Tuning
            MOIA = 494,      ///< Modulator Oscillator Inaccuracy
            MOIS = 495,      ///< Modulator Oscillator Instability
            COIA = 496,      ///< Carrier Oscillator Inaccuracy
            COIS = 497,      ///< Carrier Oscillator Instability
            MF1QLG = 498,    ///< Modulator Filter 1 Logarithmic Q Factor
            MF2QLG = 499,    ///< Modulator Filter 2 Logarithmic Q Factor
            CF1QLG = 500,    ///< Carrier Filter 1 Logarithmic Q Factor
            CF2QLG = 501,    ///< Carrier Filter 2 Logarithmic Q Factor
            EF1QLG = 502,    ///< Effects Filter 1 Logarithmic Q Factor
            EF2QLG = 503,    ///< Effects Filter 2 Logarithmic Q Factor
            L1AEN = 504,     ///< LFO 1 Amount Envelope
            L2AEN = 505,     ///< LFO 2 Amount Envelope
            L3AEN = 506,     ///< LFO 3 Amount Envelope
            L4AEN = 507,     ///< LFO 4 Amount Envelope
            L5AEN = 508,     ///< LFO 5 Amount Envelope
            L6AEN = 509,     ///< LFO 6 Amount Envelope
            L7AEN = 510,     ///< LFO 7 Amount Envelope
            L8AEN = 511,     ///< LFO 8 Amount Envelope
            N1SYN = 512,     ///< Envelope 1 Tempo Synchronization
            N2SYN = 513,     ///< Envelope 2 Tempo Synchronization
            N3SYN = 514,     ///< Envelope 3 Tempo Synchronization
            N4SYN = 515,     ///< Envelope 4 Tempo Synchronization
            N5SYN = 516,     ///< Envelope 5 Tempo Synchronization
            N6SYN = 517,     ///< Envelope 6 Tempo Synchronization
            N7SYN = 518,     ///< Envelope 7 Tempo Synchronization
            N8SYN = 519,     ///< Envelope 8 Tempo Synchronization
            N9SYN = 520,     ///< Envelope 9 Tempo Synchronization
            N10SYN = 521,     ///< Envelope 10 Tempo Synchronization
            N11SYN = 522,     ///< Envelope 11 Tempo Synchronization
            N12SYN = 523,     ///< Envelope 12 Tempo Synchronization
            N1ASH = 524,     ///< Envelope 1 Attack Shape
            N2ASH = 525,     ///< Envelope 2 Attack Shape
            N3ASH = 526,     ///< Envelope 3 Attack Shape
            N4ASH = 527,     ///< Envelope 4 Attack Shape
            N5ASH = 528,     ///< Envelope 5 Attack Shape
            N6ASH = 529,     ///< Envelope 6 Attack Shape
            N7ASH = 530,     ///< Envelope 7 Attack Shape
            N8ASH = 531,     ///< Envelope 8 Attack Shape
            N9ASH = 532,     ///< Envelope 9 Attack Shape
            N10ASH = 533,     ///< Envelope 10 Attack Shape
            N11ASH = 534,     ///< Envelope 11 Attack Shape
            N12ASH = 535,     ///< Envelope 12 Attack Shape
            N1DSH = 536,     ///< Envelope 1 Decay Shape
            N2DSH = 537,     ///< Envelope 2 Decay Shape
            N3DSH = 538,     ///< Envelope 3 Decay Shape
            N4DSH = 539,     ///< Envelope 4 Decay Shape
            N5DSH = 540,     ///< Envelope 5 Decay Shape
            N6DSH = 541,     ///< Envelope 6 Decay Shape
            N7DSH = 542,     ///< Envelope 7 Decay Shape
            N8DSH = 543,     ///< Envelope 8 Decay Shape
            N9DSH = 544,     ///< Envelope 9 Decay Shape
            N10DSH = 545,     ///< Envelope 10 Decay Shape
            N11DSH = 546,     ///< Envelope 11 Decay Shape
            N12DSH = 547,     ///< Envelope 12 Decay Shape
            N1RSH = 548,     ///< Envelope 1 Release Shape
            N2RSH = 549,     ///< Envelope 2 Release Shape
            N3RSH = 550,     ///< Envelope 3 Release Shape
            N4RSH = 551,     ///< Envelope 4 Release Shape
            N5RSH = 552,     ///< Envelope 5 Release Shape
            N6RSH = 553,     ///< Envelope 6 Release Shape
            N7RSH = 554,     ///< Envelope 7 Release Shape
            N8RSH = 555,     ///< Envelope 8 Release Shape
            N9RSH = 556,     ///< Envelope 9 Release Shape
            N10RSH = 557,     ///< Envelope 10 Release Shape
            N11RSH = 558,     ///< Envelope 11 Release Shape
            N12RSH = 559,     ///< Envelope 12 Release Shape
