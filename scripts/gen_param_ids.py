...
def print_effect_params(param_id: int, param_objs: list) -> int:
    params = [
        ...
        ("$CHPQ", " ///< $ Chorus Highpass Q Factor", "effects.chorus.high_pass_q"),
        ...
        ("$EHPQ", " ///< $ Echo Highpass Q Factor", "effects.echo.high_pass_q"),
        ...
        ("$RHPQ", " ///< $ Reverb Highpass Q Factor", "effects.reverb.high_pass_q"),
...
def print_discrete_params(param_id: int, param_objs: list) -> int:
    params = [
        ...
        ("ECLHQ", " ///< Effects Chorus Logarithmic Highpass Filter Q Factor", "effects.chorus.log_scale_high_pass_q"),
        ...
        ("EELHQ", " ///< Effects Echo Logarithmic Highpass Filter Q Factor", "effects.echo.log_scale_high_pass_q"),
        ("ERLOG", " ///< Effects Reverb Logarithmic Filter Frequencies", "effects.reverb.log_scale_frequencies"),
        ("ERLHQ", " ///< Effects Reverb Logarithmic Highpass Filter Q Factor", "effects.reverb.log_scale_high_pass_q"),
